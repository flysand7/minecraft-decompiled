...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   static final Component HARDCORE_TEXT = Component.translatable("mco.upload.hardcore").withStyle((var0) -> {
   ...
   private class WorldSelectionList extends RealmsObjectSelectionList<RealmsSelectFileToUploadScreen.Entry> {
      ...
      public void setSelected(@Nullable AbstractSelectionList.Entry var1) {
         this.setSelected((RealmsSelectFileToUploadScreen.Entry)var1);
      }
   }
