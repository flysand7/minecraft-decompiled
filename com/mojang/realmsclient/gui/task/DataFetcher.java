...
public class DataFetcher {
   ...
   public class Task<T> {
      ...
      void updateIfNeeded(long var1) {
         if (this.pendingTask != null) {
            DataFetcher.ComputationResult var3 = (DataFetcher.ComputationResult)this.pendingTask.getNow((Object)null);
            if (var3 == null) {
               return;
            }
            ...
            var3.value().ifLeft((var3x) -> {
               this.lastResult = new DataFetcher.SuccessfulComputationResult(var3x, var4);
         ...
         if (this.nextUpdate <= var1) {
            this.pendingTask = CompletableFuture.supplyAsync(() -> {
               ...
               try {
                  ...
                  return new DataFetcher.ComputationResult(Either.left(var1), var2);
               } catch (Exception var4) {
                  var2 = DataFetcher.this.timeSource.get(DataFetcher.this.resolution);
                  return new DataFetcher.ComputationResult(Either.right(var4), var2);
               }
   ...
   public class Subscription {
      ...
      public void forceUpdate() {
         ...
         while(var1.hasNext()) {
            DataFetcher.SubscribedTask var2 = (DataFetcher.SubscribedTask)var1.next();
            var2.runCallback();
         }
