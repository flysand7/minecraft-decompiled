...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   public ResourceLocation(String var1, String var2) {
      this(assertValidNamespace(var1, var2), assertValidPath(var1, var2), (ResourceLocation.Dummy)null);
   }
   ...
   public ResourceLocation withPath(String var1) {
      return new ResourceLocation(this.namespace, assertValidPath(this.namespace, var1), (ResourceLocation.Dummy)null);
   }
