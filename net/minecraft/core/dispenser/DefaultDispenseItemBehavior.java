...
public class DefaultDispenseItemBehavior implements DispenseItemBehavior {
   ...
   public static void spawnItem(Level var0, ItemStack var1, int var2, Direction var3, Position var4) {
      ...
      var11.setDeltaMovement(var0.random.triangle((double)var3.getStepX() * var12, 0.0172275D * (double)var2), var0.random.triangle(0.2D, 0.0172275D * (double)var2), var0.random.triangle((double)var3.getStepZ() * var12, 0.0172275D * (double)var2));
