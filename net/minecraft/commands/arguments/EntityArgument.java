...
public class EntityArgument implements ArgumentType<EntitySelector> {
   ...
   public static class Info implements ArgumentTypeInfo<EntityArgument, EntityArgument.Info.Template> {
      ...
      public ArgumentTypeInfo.Template unpack(ArgumentType var1) {
         return this.unpack((EntityArgument)var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void serializeToJson(ArgumentTypeInfo.Template var1, JsonObject var2) {
         this.serializeToJson((EntityArgument.Info.Template)var1, var2);
      }
      ...
      public void serializeToNetwork(ArgumentTypeInfo.Template var1, FriendlyByteBuf var2) {
         this.serializeToNetwork((EntityArgument.Info.Template)var1, var2);
      }
