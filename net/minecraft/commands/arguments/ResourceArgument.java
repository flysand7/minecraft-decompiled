...
public class ResourceArgument<T> implements ArgumentType<Holder.Reference<T>> {
   ...
   private static final DynamicCommandExceptionType ERROR_NOT_SUMMONABLE_ENTITY = new DynamicCommandExceptionType((var0) -> {
      return Component.translatable("entity.not_summonable", var0);
   });
   public static final Dynamic2CommandExceptionType ERROR_UNKNOWN_RESOURCE = new Dynamic2CommandExceptionType((var0, var1) -> {
      return Component.translatable("argument.resource.not_found", var0, var1);
   });
   public static final Dynamic3CommandExceptionType ERROR_INVALID_RESOURCE_TYPE = new Dynamic3CommandExceptionType((var0, var1, var2) -> {
      return Component.translatable("argument.resource.invalid_type", var0, var1, var2);
   });
   ...
   public Holder.Reference<T> parse(StringReader var1) throws CommandSyntaxException {
      ...
      return (Holder.Reference)this.registryLookup.get(var3).orElseThrow(() -> {
         return ERROR_UNKNOWN_RESOURCE.create(var2, this.registryKey.location());
      });
   }
   ...
   public static class Info<T> implements ArgumentTypeInfo<ResourceArgument<T>, ResourceArgument.Info<T>.Template> {
      ...
      public ArgumentTypeInfo.Template unpack(ArgumentType var1) {
         return this.unpack((ResourceArgument)var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void serializeToJson(ArgumentTypeInfo.Template var1, JsonObject var2) {
         this.serializeToJson((ResourceArgument.Info.Template)var1, var2);
      }
      ...
      public void serializeToNetwork(ArgumentTypeInfo.Template var1, FriendlyByteBuf var2) {
         this.serializeToNetwork((ResourceArgument.Info.Template)var1, var2);
      }
