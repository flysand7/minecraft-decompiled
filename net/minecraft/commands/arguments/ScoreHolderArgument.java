...
public class ScoreHolderArgument implements ArgumentType<ScoreHolderArgument.Result> {
   ...
   public static class Info implements ArgumentTypeInfo<ScoreHolderArgument, ScoreHolderArgument.Info.Template> {
      ...
      public ArgumentTypeInfo.Template unpack(ArgumentType var1) {
         return this.unpack((ScoreHolderArgument)var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void serializeToJson(ArgumentTypeInfo.Template var1, JsonObject var2) {
         this.serializeToJson((ScoreHolderArgument.Info.Template)var1, var2);
      }
      ...
      public void serializeToNetwork(ArgumentTypeInfo.Template var1, FriendlyByteBuf var2) {
         this.serializeToNetwork((ScoreHolderArgument.Info.Template)var1, var2);
      }
