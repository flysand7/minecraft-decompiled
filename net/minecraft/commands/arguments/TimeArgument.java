...
public class TimeArgument implements ArgumentType<Integer> {
   ...
   private static final Dynamic2CommandExceptionType ERROR_TICK_COUNT_TOO_LOW = new Dynamic2CommandExceptionType((var0, var1) -> {
      return Component.translatable("argument.time.tick_count_too_low", var1, var0);
   });
   ...
   public static class Info implements ArgumentTypeInfo<TimeArgument, TimeArgument.Info.Template> {
      ...
      public ArgumentTypeInfo.Template unpack(ArgumentType var1) {
         return this.unpack((TimeArgument)var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void serializeToJson(ArgumentTypeInfo.Template var1, JsonObject var2) {
         this.serializeToJson((TimeArgument.Info.Template)var1, var2);
      }
      ...
      public void serializeToNetwork(ArgumentTypeInfo.Template var1, FriendlyByteBuf var2) {
         this.serializeToNetwork((TimeArgument.Info.Template)var1, var2);
      }
