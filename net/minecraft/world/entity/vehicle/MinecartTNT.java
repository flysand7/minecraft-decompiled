...
public class MinecartTNT extends AbstractMinecart {
   ...
   public void destroy(DamageSource var1) {
      ...
      if (!var1.is(DamageTypeTags.IS_FIRE) && !var1.is(DamageTypeTags.IS_EXPLOSION) && !(var2 >= 0.009999999776482582D)) {
         super.destroy(var1);
      } else {
         if (this.fuse < 0) {
            this.primeFuse();
   ...
   protected void explode(@Nullable DamageSource var1, double var2) {
      if (!this.level().isClientSide) {
         ...
         this.level().explode(this, var1, (ExplosionDamageCalculator)null, this.getX(), this.getY(), this.getZ(), (float)(4.0D + this.random.nextDouble() * 1.5D * var4), false, Level.ExplosionInteraction.TNT);
         this.discard();
      }
