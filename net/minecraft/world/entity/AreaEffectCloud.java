...
public class AreaEffectCloud extends Entity implements TraceableEntity {
      ...
      if (this.level().isClientSide) {
         ...
         if (this.tickCount % 5 == 0) {
            ...
            while(var24.hasNext()) {
               ...
               var23.add(new MobEffectInstance(var26.getEffect(), var26.mapDuration((var0) -> {
                  return var0 / 4;
               }), var26.getAmplifier(), var26.isAmbient(), var26.isVisible()));
            }
   ...
   protected void readAdditionalSaveData(CompoundTag var1) {
      ...
      if (var1.contains("Particle", 8)) {
         try {
            this.setParticle(ParticleArgument.readParticle(new StringReader(var1.getString("Particle")), (HolderLookup)BuiltInRegistries.PARTICLE_TYPE.asLookup()));
