      ...
      if (this.getInvulnerableTicks() > 0) {
         ...
         for(var1 = 1; var1 < 3; ++var1) {
            if (this.tickCount >= this.nextHeadUpdate[var1 - 1]) {
               ...
               if (var13 > 0) {
                  LivingEntity var15 = (LivingEntity)this.level().getEntity(var13);
                  if (var15 != null && this.canAttack(var15) && !(this.distanceToSqr(var15) > 900.0D) && this.hasLineOfSight(var15)) {
                     this.performRangedAttack(var1 + 1, var15);
                  ...
                  List var14 = this.level().getNearbyEntities(LivingEntity.class, TARGETING_CONDITIONS, this, this.getBoundingBox().inflate(20.0D, 8.0D, 20.0D));
                  if (!var14.isEmpty()) {
                     LivingEntity var17 = (LivingEntity)var14.get(this.random.nextInt(var14.size()));
               ...
               for(int var5 = -1; var5 <= 1; ++var5) {
                  for(int var19 = -1; var19 <= 1; ++var19) {
                     for(int var7 = 0; var7 <= 3; ++var7) {
                        ...
                        int var9 = var1 + var7;
                        int var10 = var16 + var19;
                        BlockPos var11 = new BlockPos(var20, var9, var10);
                        BlockState var12 = this.level().getBlockState(var11);
                        if (canDestroy(var12)) {
                           var18 = this.level().destroyBlock(var11, true, this) || var18;
                        }
                     }
                  }
               }
