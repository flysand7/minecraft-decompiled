...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      if (this.isDeadOrDying()) {
         ...
         this.level().addParticle(ParticleTypes.EXPLOSION, this.getX() + (double)var25, this.getY() + 2.0D + (double)var27, this.getZ() + (double)var33, 0.0D, 0.0D, 0.0D);
      } else {
         this.checkCrystals();
         Vec3 var24 = this.getDeltaMovement();
         var27 = 0.2F / ((float)var24.horizontalDistance() * 10.0F + 1.0F);
         var27 *= (float)Math.pow(2.0D, var24.y);
         ...
         if (this.isNoAi()) {
            ...
            if (this.level().isClientSide) {
               if (this.lerpSteps > 0) {
                  double var28 = this.getX() + (this.lerpX - this.getX()) / (double)this.lerpSteps;
                  ...
                  --this.lerpSteps;
                  this.setPos(var28, var5, var7);
                  this.setRot(this.getYRot(), this.getXRot());
               }

               this.phaseManager.getCurrentPhase().doClientTick();
            } else {
               DragonPhaseInstance var29 = this.phaseManager.getCurrentPhase();
               var29.doServerTick();
               if (this.phaseManager.getCurrentPhase() != var29) {
                  var29 = this.phaseManager.getCurrentPhase();
                  var29.doServerTick();
               }

               Vec3 var4 = var29.getFlyTargetLocation();
               if (var4 != null) {
                  var5 = var4.x - this.getX();
                  var7 = var4.y - this.getY();
                  var9 = var4.z - this.getZ();
                  double var11 = var5 * var5 + var7 * var7 + var9 * var9;
                  float var13 = var29.getFlySpeed();
                  ...
                  if (Math.abs(var5) > 9.999999747378752E-6D || Math.abs(var9) > 9.999999747378752E-6D) {
                     ...
                     this.yRotA *= 0.8F;
                     this.yRotA += var19 * var29.getTurnSpeed();
                     this.setYRot(this.getYRot() + this.yRotA * 0.1F);
                  }

                  var19 = (float)(2.0D / (var11 + 1.0D));
                  var20 = 0.06F;
                  this.moveRelative(0.06F * (var18 * var19 + (1.0F - var19)), new Vec3(0.0D, 0.0D, -1.0D));
                  if (this.inWall) {
            ...
            for(int var30 = 0; var30 < this.subEntities.length; ++var30) {
               var31[var30] = new Vec3(this.subEntities[var30].getX(), this.subEntities[var30].getY(), this.subEntities[var30].getZ());
            }
            ...
            this.tickPart(this.body, (double)(var8 * 0.5F), 0.0D, (double)(-var36 * 0.5F));
            this.tickPart(this.wing1, (double)(var36 * 4.5F), 2.0D, (double)(var8 * 4.5F));
            this.tickPart(this.wing2, (double)(var36 * -4.5F), 2.0D, (double)(var8 * -4.5F));
            ...
            float var37 = Mth.cos(this.getYRot() * 0.017453292F - this.yRotA * 0.01F);
            float var12 = this.getHeadYOffset();
            this.tickPart(this.head, (double)(var10 * 6.5F * var34), (double)(var12 + var6 * 6.5F), (double)(-var37 * 6.5F * var34));
            this.tickPart(this.neck, (double)(var10 * 5.5F * var34), (double)(var12 + var6 * 5.5F), (double)(-var37 * 5.5F * var34));
            double[] var38 = this.getLatencyPos(5, 1.0F);
            ...
            for(var39 = 0; var39 < 3; ++var39) {
               ...
               double[] var40 = this.getLatencyPos(12 + var39 * 2, 1.0F);
               float var41 = this.getYRot() * 0.017453292F + this.rotWrap(var40[0] - var38[0]) * 0.017453292F;
               var18 = Mth.sin(var41);
               var19 = Mth.cos(var41);
               var20 = 1.5F;
               float var42 = (float)(var39 + 1) * 2.0F;
               this.tickPart(var15, (double)(-(var8 * 1.5F + var18 * var42) * var34), var40[1] - var38[1] - (double)((var42 + 1.5F) * var6) + 1.5D, (double)((var36 * 1.5F + var19 * var42) * var34));
            }
            ...
            for(var39 = 0; var39 < this.subEntities.length; ++var39) {
               this.subEntities[var39].xo = var31[var39].x;
               this.subEntities[var39].yo = var31[var39].y;
               this.subEntities[var39].zo = var31[var39].z;
               this.subEntities[var39].xOld = var31[var39].x;
               this.subEntities[var39].yOld = var31[var39].y;
               this.subEntities[var39].zOld = var31[var39].z;
            }
   ...
   public float getHeadPartYOffset(int var1, double[] var2, double[] var3) {
      ...
      if (var5 != EnderDragonPhase.LANDING && var5 != EnderDragonPhase.TAKEOFF) {
         ...
         double var9 = Math.max(Math.sqrt(var8.distToCenterSqr(this.position())) / 4.0D, 1.0D);
