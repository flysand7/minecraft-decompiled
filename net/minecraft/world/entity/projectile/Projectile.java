...
public abstract class Projectile extends Entity implements TraceableEntity {
   ...
   public void shoot(double var1, double var3, double var5, float var7, float var8) {
      Vec3 var9 = (new Vec3(var1, var3, var5)).normalize().add(this.random.triangle(0.0D, 0.0172275D * (double)var8), this.random.triangle(0.0D, 0.0172275D * (double)var8), this.random.triangle(0.0D, 0.0172275D * (double)var8)).scale((double)var7);
