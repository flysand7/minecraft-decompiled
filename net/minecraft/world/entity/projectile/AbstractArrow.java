...
public abstract class AbstractArrow extends Projectile {
   ...
   protected void onHitEntity(EntityHitResult var1) {
      ...
      if (var2.hurt(var13, (float)var4)) {
         ...
         if (var2 instanceof LivingEntity) {
            ...
            if (this.knockback > 0) {
               double var10 = Math.max(0.0D, 1.0D - var9.getAttributeValue(Attributes.KNOCKBACK_RESISTANCE));
               Vec3 var12 = this.getDeltaMovement().multiply(1.0D, 0.0D, 1.0D).normalize().scale((double)this.knockback * 0.6D * var10);
               if (var12.lengthSqr() > 0.0D) {
                  var9.push(var12.x, 0.1D, var12.z);
               }
            }
   ...
   public void setEnchantmentEffectsFromEntity(LivingEntity var1, float var2) {
      ...
      this.setBaseDamage((double)(var2 * 2.0F) + this.random.triangle((double)this.level().getDifficulty().getId() * 0.11D, 0.57425D));
      if (var3 > 0) {
