      ...
      if (this.isAttachedToEntity()) {
         ...
         if (this.attachedToEntity != null) {
            if (this.attachedToEntity.isFallFlying()) {
               ...
               this.attachedToEntity.setDeltaMovement(var7.add(var2.x * 0.1D + (var2.x * 1.5D - var7.x) * 0.5D, var2.y * 0.1D + (var2.y * 1.5D - var7.y) * 0.5D, var2.z * 0.1D + (var2.z * 1.5D - var7.z) * 0.5D));
         ...
         if (!this.isShotAtAngle()) {
            double var8 = this.horizontalCollision ? 1.0D : 1.15D;
            this.setDeltaMovement(this.getDeltaMovement().multiply(var8, 1.0D, var8).add(0.0D, 0.04D, 0.0D));
         }
