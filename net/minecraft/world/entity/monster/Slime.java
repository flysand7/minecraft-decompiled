...
public class Slime extends Mob implements Enemy {
   ...
   protected void dealDamage(LivingEntity var1) {
      if (this.isAlive()) {
         int var2 = this.getSize();
         if (this.distanceToSqr(var1) < 0.6D * (double)var2 * 0.6D * (double)var2 && this.hasLineOfSight(var1) && var1.hurt(this.damageSources().mobAttack(this), this.getAttackDamage())) {
   ...
   static class SlimeFloatGoal extends Goal {
      ...
      public void tick() {
         ...
         if (var2 instanceof Slime.SlimeMoveControl) {
            Slime.SlimeMoveControl var1 = (Slime.SlimeMoveControl)var2;
            var1.setWantedMovement(1.2D);
         }
   ...
   private static class SlimeAttackGoal extends Goal {
      ...
      public void tick() {
         ...
         if (var3 instanceof Slime.SlimeMoveControl) {
            Slime.SlimeMoveControl var2 = (Slime.SlimeMoveControl)var3;
