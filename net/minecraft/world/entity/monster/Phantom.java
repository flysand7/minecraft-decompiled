...
public class Phantom extends FlyingMob implements Enemy {
   ...
   class PhantomMoveControl extends MoveControl {
      ...
      public void tick() {
         ...
         if (Math.abs(var7) > 9.999999747378752E-6D) {
            double var9 = 1.0D - Math.abs(var3 * 0.699999988079071D) / var7;
            var1 *= var9;
            var5 *= var9;
            ...
            float var17 = (float)(-(Mth.atan2(-var3, var7) * 57.2957763671875D));
            ...
            Phantom.this.setDeltaMovement(var25.add((new Vec3(var19, var23, var21)).subtract(var25).scale(0.2D)));
         }
