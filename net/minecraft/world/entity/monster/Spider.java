...
public class Spider extends Monster {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4, @Nullable CompoundTag var5) {
      Object var9 = super.finalizeSpawn(var1, var2, var3, var4, var5);
      ...
      if (var9 == null) {
         ...
         if (var1.getDifficulty() == Difficulty.HARD && var6.nextFloat() < 0.1F * var2.getSpecialMultiplier()) {
            ((Spider.SpiderEffectsGroupData)var9).setRandomEffect(var6);
         }
      }

      if (var9 instanceof Spider.SpiderEffectsGroupData) {
         Spider.SpiderEffectsGroupData var10 = (Spider.SpiderEffectsGroupData)var9;
