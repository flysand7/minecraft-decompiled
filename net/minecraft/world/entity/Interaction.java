...
public class Interaction extends Entity implements Attackable, Targeting {
   ...
   protected void readAdditionalSaveData(CompoundTag var1) {
      ...
      if (var1.contains("attack")) {
         ...
         var10000.resultOrPartial(Util.prefix("Interaction entity", var10002::error)).ifPresent((var1x) -> {
            this.attack = (Interaction.PlayerAction)var1x.getFirst();
         });
      } else {
         this.attack = null;
      }
      ...
      if (var1.contains("interaction")) {
         ...
         Objects.requireNonNull(var10002);
         var10000.resultOrPartial(Util.prefix("Interaction entity", var10002::error)).ifPresent((var1x) -> {
            this.interaction = (Interaction.PlayerAction)var1x.getFirst();
         });
      } else {
   ...
   protected void addAdditionalSaveData(CompoundTag var1) {
      ...
      if (this.attack != null) {
         Interaction.PlayerAction.CODEC.encodeStart(NbtOps.INSTANCE, this.attack).result().ifPresent((var1x) -> {
            var1.put("attack", var1x);
         });
      }

      if (this.interaction != null) {
         Interaction.PlayerAction.CODEC.encodeStart(NbtOps.INSTANCE, this.interaction).result().ifPresent((var1x) -> {
   ...
   private static record PlayerAction(UUID b, long c) {
