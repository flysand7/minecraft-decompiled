...
public class PoiManager extends SectionStorage<PoiSection> {
   ...
   public Stream<Pair<Holder<PoiType>, BlockPos>> findAllWithType(Predicate<Holder<PoiType>> var1, Predicate<BlockPos> var2, BlockPos var3, int var4, PoiManager.Occupancy var5) {
   ...
   public Stream<Pair<Holder<PoiType>, BlockPos>> findAllClosestFirstWithType(Predicate<Holder<PoiType>> var1, Predicate<BlockPos> var2, BlockPos var3, int var4, PoiManager.Occupancy var5) {
   ...
   public Optional<BlockPos> getRandom(Predicate<Holder<PoiType>> var1, Predicate<BlockPos> var2, PoiManager.Occupancy var3, BlockPos var4, int var5, RandomSource var6) {
