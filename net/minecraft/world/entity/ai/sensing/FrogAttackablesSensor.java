...
public class FrogAttackablesSensor extends NearestVisibleLivingEntitySensor {
   ...
   protected boolean isMatchingEntity(LivingEntity var1, LivingEntity var2) {
      return !var1.getBrain().hasMemoryValue(MemoryModuleType.HAS_HUNTING_COOLDOWN) && Sensor.isEntityAttackable(var1, var2) && Frog.canEat(var2) && !this.isUnreachableAttackTarget(var1, var2) ? var2.closerThan(var1, 10.0D) : false;
   }
