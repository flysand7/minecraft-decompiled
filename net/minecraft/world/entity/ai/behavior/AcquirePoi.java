            ...
            return (var6, var7x, var8x) -> {
               if (var3 && var7x.isBaby()) {
                  ...
                  var8.long2ObjectEntrySet().removeIf((var2) -> {
                     return !((AcquirePoi.JitteredLinearRetry)var2.getValue()).isStillValid(var8x);
                  });
                  Predicate var11 = (var3x) -> {
                     AcquirePoi.JitteredLinearRetry var4 = (AcquirePoi.JitteredLinearRetry)var8.get(var3x.asLong());
                     if (var4 == null) {
                        return true;
                  ...
                  if (var13 != null && var13.canReach()) {
                     ...
                     while(var14.hasNext()) {
                        ...
                        var8.computeIfAbsent(((BlockPos)var15.getSecond()).asLong(), (var3x) -> {
                           return new AcquirePoi.JitteredLinearRetry(var6.random, var8x);
                        });
                     }
                  }
