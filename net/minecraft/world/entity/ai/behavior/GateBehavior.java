...
public class GateBehavior<E extends LivingEntity> implements BehaviorControl<E> {
   ...
   public GateBehavior(Map<MemoryModuleType<?>, MemoryStatus> var1, Set<MemoryModuleType<?>> var2, GateBehavior.OrderPolicy var3, GateBehavior.RunningPolicy var4, List<Pair<? extends BehaviorControl<? super E>, Integer>> var5) {
