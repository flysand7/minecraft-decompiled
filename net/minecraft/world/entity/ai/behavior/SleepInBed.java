...
public class SleepInBed extends Behavior<LivingEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
      if (var2.isPassenger()) {
         ...
         if (var1.dimension() != var4.dimension()) {
            ...
            return var4.pos().closerToCenterThan(var2.position(), 2.0D) && var8.is(BlockTags.BEDS) && !(Boolean)var8.getValue(BedBlock.OCCUPIED);
         }
      }
   }
   ...
   protected boolean canStillUse(ServerLevel var1, LivingEntity var2, long var3) {
      ...
      if (!var5.isPresent()) {
         ...
         return var2.getBrain().isActive(Activity.REST) && var2.getY() > (double)var6.getY() + 0.4D && var6.closerToCenterThan(var2.position(), 1.14D);
      }
   }
