...
public class BehaviorUtils {
   ...
   public static boolean isWithinAttackRange(Mob var0, LivingEntity var1, int var2) {
      ...
      if (var4 instanceof ProjectileWeaponItem) {
         ProjectileWeaponItem var3 = (ProjectileWeaponItem)var4;
   ...
   public static Vec3 getRandomSwimmablePos(PathfinderMob var0, int var1, int var2) {
      ...
      for(int var4 = 0; var3 != null && !var0.level().getBlockState(BlockPos.containing(var3)).isPathfindable(var0.level(), BlockPos.containing(var3), PathComputationType.WATER) && var4++ < 10; var3 = DefaultRandomPos.getPos(var0, var1, var2)) {
      }
