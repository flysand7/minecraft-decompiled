...
public class RamTarget extends Behavior<Goat> {
   ...
   protected void tick(ServerLevel var1, Goat var2, long var3) {
      ...
      if (!var5.isEmpty()) {
         ...
         boolean var16 = var14.isEmpty() || var15.isEmpty() || ((WalkTarget)var14.get()).getTarget().currentPosition().closerThan((Position)var15.get(), 0.25D);
         if (var16) {
            this.finishRam(var1, var2);
         }
      }
   ...
   private boolean hasRammedHornBreakingBlock(ServerLevel var1, Goat var2) {
      Vec3 var3 = var2.getDeltaMovement().multiply(1.0D, 0.0D, 1.0D).normalize();
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
      return this.checkExtraStartConditions(var1, (Goat)var2);
   }
