...
public class Painting extends HangingEntity implements VariantHolder<Holder<PaintingVariant>> {
   ...
   public void readAdditionalSaveData(CompoundTag var1) {
      Holder var2 = (Holder)loadVariant(var1).orElseGet(Painting::getDefaultVariant);
   ...
   public static void storeVariant(CompoundTag var0, Holder<PaintingVariant> var1) {
      var0.putString("variant", ((ResourceKey)var1.unwrapKey().orElse(DEFAULT_VARIANT)).location().toString());
   }

   public static Optional<Holder<PaintingVariant>> loadVariant(CompoundTag var0) {
      Optional var10000 = Optional.ofNullable(ResourceLocation.tryParse(var0.getString("variant"))).map((var0x) -> {
         return ResourceKey.create(Registries.PAINTING_VARIANT, var0x);
      });
      DefaultedRegistry var10001 = BuiltInRegistries.PAINTING_VARIANT;
      Objects.requireNonNull(var10001);
      return var10000.flatMap(var10001::getHolder);
   }
