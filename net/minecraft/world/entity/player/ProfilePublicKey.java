...
public record ProfilePublicKey(ProfilePublicKey.Data d) {
   ...
   public static record Data(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<ProfilePublicKey.Data> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(ExtraCodecs.INSTANT_ISO8601.fieldOf("expires_at").forGetter(ProfilePublicKey.Data::expiresAt), Crypt.PUBLIC_KEY_CODEC.fieldOf("key").forGetter(ProfilePublicKey.Data::key), ExtraCodecs.BASE64_STRING.fieldOf("signature_v2").forGetter(ProfilePublicKey.Data::keySignature)).apply(var0, ProfilePublicKey.Data::new);
      });
