...
public class CamelAi {
   ...
   private static void initCoreActivity(Brain<Camel> var0) {
      var0.addActivity(Activity.CORE, 0, ImmutableList.of(new Swim(0.8F), new CamelAi.CamelPanic(4.0F), new LookAtTargetSink(45, 90), new MoveToTargetSink(), new CountDownCooldownTicks(MemoryModuleType.TEMPTATION_COOLDOWN_TICKS), new CountDownCooldownTicks(MemoryModuleType.GAZE_COOLDOWN_TICKS)));
   }

   private static void initIdleActivity(Brain<Camel> var0) {
      var0.addActivity(Activity.IDLE, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(1, new AnimalMakeLove(EntityType.CAMEL, 1.0F)), Pair.of(2, new FollowTemptation((var0x) -> {
         return 2.5F;
   ...
   public static class CamelPanic extends AnimalPanic {
      ...
      protected void start(ServerLevel var1, PathfinderMob var2, long var3) {
         if (var2 instanceof Camel) {
            Camel var5 = (Camel)var2;
   ...
   public static class RandomSitting extends Behavior<Camel> {
      ...
      protected boolean checkExtraStartConditions(ServerLevel var1, Camel var2) {
         return !var2.isInWater() && var2.getPoseTime() >= (long)this.minimalPoseTicks && !var2.isLeashed() && var2.onGround() && !var2.hasControllingPassenger();
      }
      ...
      protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
         return this.checkExtraStartConditions(var1, (Camel)var2);
      }
