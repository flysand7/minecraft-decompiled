...
public class Dolphin extends WaterAnimal {
   ...
   protected boolean closeToNextPos() {
      ...
      return var1 != null ? var1.closerToCenterThan(this.position(), 12.0D) : false;
   }
   ...
   private static class DolphinSwimToTreasureGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         ...
         return !BlockPos.containing((double)var1.getX(), this.dolphin.getY(), (double)var1.getZ()).closerToCenterThan(this.dolphin.position(), 4.0D) && !this.stuck && this.dolphin.getAirSupply() >= 100;
      }
      ...
      public void stop() {
         BlockPos var1 = this.dolphin.getTreasurePos();
         if (BlockPos.containing((double)var1.getX(), this.dolphin.getY(), (double)var1.getZ()).closerToCenterThan(this.dolphin.position(), 4.0D) || this.stuck) {
