...
public class Axolotl extends Animal implements LerpingModel, VariantHolder<Axolotl.Variant>, Bucketable {
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor var1, DifficultyInstance var2, MobSpawnType var3, @Nullable SpawnGroupData var4, @Nullable CompoundTag var5) {
      ...
      if (var3 == MobSpawnType.BUCKET) {
         ...
         if (var4 instanceof Axolotl.AxolotlGroupData) {
            ...
            var4 = new Axolotl.AxolotlGroupData(new Axolotl.Variant[]{Axolotl.Variant.getCommonSpawnVariant(var7), Axolotl.Variant.getCommonSpawnVariant(var7)});
         }
      ...
      if (var1.isDeadOrDying()) {
         ...
         if (var3 != null) {
            ...
            if (var4 != null && var4.getType() == EntityType.PLAYER) {
               ...
               List var6 = var2.getEntitiesOfClass(Player.class, var0.getBoundingBox().inflate(20.0D));
   ...
   public void setVariant(Object var1) {
      this.setVariant((Axolotl.Variant)var1);
   }
