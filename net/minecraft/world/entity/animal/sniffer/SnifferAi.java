...
public class SnifferAi {
   ...
   static class Searching extends Behavior<Sniffer> {
      ...
      protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
         return this.checkExtraStartConditions(var1, (Sniffer)var2);
      }

      // $FF: synthetic method
      // $FF: bridge method
      protected boolean canStillUse(ServerLevel var1, LivingEntity var2, long var3) {
         return this.canStillUse(var1, (Sniffer)var2, var3);
      }
