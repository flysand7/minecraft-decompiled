...
public class FrogAi {
   ...
   private static void initIdleActivity(Brain<Frog> var0) {
      var0.addActivityWithConditions(Activity.IDLE, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(0, new AnimalMakeLove(EntityType.FROG, 1.0F)), Pair.of(1, new FollowTemptation((var0x) -> {
         return 1.25F;
   ...
   private static <E extends Mob> boolean isAcceptableLandingSpot(E var0, BlockPos var1) {
      ...
      if (var2.getFluidState(var1).isEmpty() && var2.getFluidState(var3).isEmpty() && var2.getFluidState(var1.above()).isEmpty()) {
         ...
         if (!var4.is(BlockTags.FROG_PREFER_JUMP_TO) && !var5.is(BlockTags.FROG_PREFER_JUMP_TO)) {
            ...
            return var6 != BlockPathTypes.TRAPDOOR && (!var4.isAir() || var7 != BlockPathTypes.TRAPDOOR) ? LongJumpToRandomPos.defaultAcceptableLandingSpot(var0, var1) : true;
         } else {
            return true;
         }
      } else {
