...
public class ShootTongue extends Behavior<Frog> {
   ...
   protected void tick(ServerLevel var1, Frog var2, long var3) {
      ...
      case MOVE_TO_TARGET:
         if (var5.distanceTo(var2) < 1.75F) {
            ...
            var5.setDeltaMovement(var5.position().vectorTo(var2.position()).normalize().scale(0.75D));
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
      return this.checkExtraStartConditions(var1, (Frog)var2);
   }
   ...
   static enum State {
      ...
      // $FF: synthetic method
      private static ShootTongue.State[] $values() {
         return new ShootTongue.State[]{MOVE_TO_TARGET, CATCH_ANIMATION, EAT_ANIMATION, DONE};
      }
   }
}
