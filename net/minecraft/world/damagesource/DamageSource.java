...
public class DamageSource {
   ...
   public Component getLocalizedDeathMessage(LivingEntity var1) {
      ...
      if (this.causingEntity == null && this.directEntity == null) {
         ...
         return !var4.isEmpty() && var4.hasCustomHoverName() ? Component.translatable(var2 + ".item", var1.getDisplayName(), var3, var4.getDisplayName()) : Component.translatable(var2, var1.getDisplayName(), var3);
      }
   }
