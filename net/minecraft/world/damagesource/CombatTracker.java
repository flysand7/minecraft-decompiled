...
public class CombatTracker {
   ...
   private Component getMessageForAssistedFall(Entity var1, Component var2, String var3, String var4) {
      ...
      return !var5.isEmpty() && var5.hasCustomHoverName() ? Component.translatable(var3, this.mob.getDisplayName(), var2, var5.getDisplayName()) : Component.translatable(var4, this.mob.getDisplayName(), var2);
   }
   ...
   private CombatEntry getMostSignificantFall() {
      ...
      for(int var5 = 0; var5 < this.entries.size(); ++var5) {
         ...
         float var10 = var9 ? Float.MAX_VALUE : var6.fallDistance();
