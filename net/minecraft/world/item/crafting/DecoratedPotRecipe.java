...
public class DecoratedPotRecipe extends CustomRecipe {
   ...
   public ItemStack assemble(CraftingContainer var1, RegistryAccess var2) {
      DecoratedPotBlockEntity.Decorations var3 = new DecoratedPotBlockEntity.Decorations(var1.getItem(1).getItem(), var1.getItem(3).getItem(), var1.getItem(5).getItem(), var1.getItem(7).getItem());
