...
public class SimpleCookingSerializer<T extends AbstractCookingRecipe> implements RecipeSerializer<T> {
   ...
   public T fromJson(ResourceLocation var1, JsonObject var2) {
      ...
      CookingBookCategory var4 = (CookingBookCategory)CookingBookCategory.CODEC.byName(GsonHelper.getAsString(var2, "category", (String)null), CookingBookCategory.MISC);
      Object var5 = GsonHelper.isArrayNode(var2, "ingredient") ? GsonHelper.getAsJsonArray(var2, "ingredient") : GsonHelper.getAsJsonObject(var2, "ingredient");
      ...
      ItemStack var9 = new ItemStack((ItemLike)BuiltInRegistries.ITEM.getOptional(var8).orElseThrow(() -> {
         return new IllegalStateException("Item: " + var7 + " does not exist");
      }));
   ...
   public T fromNetwork(ResourceLocation var1, FriendlyByteBuf var2) {
      ...
      CookingBookCategory var4 = (CookingBookCategory)var2.readEnum(CookingBookCategory.class);
   ...
   public void toNetwork(FriendlyByteBuf var1, Recipe var2) {
      this.toNetwork(var1, (AbstractCookingRecipe)var2);
   }
