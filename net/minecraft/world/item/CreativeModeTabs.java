...
public class CreativeModeTabs {
   ...
   public static CreativeModeTab bootstrap(Registry<CreativeModeTab> var0) {
      ...
      Registry.register(var0, (ResourceKey)NATURAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 2).title(Component.translatable("itemGroup.natural")).icon(() -> {
         ...
         var1.accept((ItemLike)Items.GRASS);
      ...
      Registry.register(var0, (ResourceKey)COMBAT, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 1).title(Component.translatable("itemGroup.combat")).icon(() -> {
         ...
         var0x.holders().lookup(Registries.POTION).ifPresent((var1x) -> {
            generatePotionEffectTypes(var1, var1x, Items.TIPPED_ARROW, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
         });
      }).build());
      ...
      Registry.register(var0, (ResourceKey)INGREDIENTS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3).title(Component.translatable("itemGroup.ingredients")).icon(() -> {
         ...
         var1.accept((ItemLike)Items.SCUTE);
   ...
   private static void generatePotionEffectTypes(CreativeModeTab.Output var0, HolderLookup<Potion> var1, Item var2, CreativeModeTab.TabVisibility var3) {
      var1.listElements().filter((var0x) -> {
         return !var0x.is(Potions.EMPTY_ID);
      }).map((var1x) -> {
         return PotionUtils.setPotion(new ItemStack(var2), (Potion)var1x.value());
      }).forEach((var2x) -> {
         var0.accept(var2x, var3);
      });
   }

   private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output var0, HolderLookup<Enchantment> var1, Set<EnchantmentCategory> var2, CreativeModeTab.TabVisibility var3) {
      var1.listElements().map(Holder::value).filter((var1x) -> {
         return var2.contains(var1x.category);
      }).map((var0x) -> {
   ...
   private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output var0, HolderLookup<Enchantment> var1, Set<EnchantmentCategory> var2, CreativeModeTab.TabVisibility var3) {
      var1.listElements().map(Holder::value).filter((var1x) -> {
         return var2.contains(var1x.category);
      }).flatMap((var0x) -> {
