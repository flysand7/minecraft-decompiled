...
public class TrimPatterns {
   ...
   public static Optional<Holder.Reference<TrimPattern>> getFromTemplate(RegistryAccess var0, ItemStack var1) {
      return var0.registryOrThrow(Registries.TRIM_PATTERN).holders().filter((var1x) -> {
   ...
   private static void register(BootstapContext<TrimPattern> var0, Item var1, ResourceKey<TrimPattern> var2) {
      TrimPattern var3 = new TrimPattern(var2.location(), BuiltInRegistries.ITEM.wrapAsHolder(var1), Component.translatable(Util.makeDescriptionId("trim_pattern", var2.location())));
