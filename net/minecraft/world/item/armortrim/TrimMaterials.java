...
public class TrimMaterials {
   ...
   public static Optional<Holder.Reference<TrimMaterial>> getFromIngredient(RegistryAccess var0, ItemStack var1) {
      return var0.registryOrThrow(Registries.TRIM_MATERIAL).holders().filter((var1x) -> {
   ...
   private static void register(BootstapContext<TrimMaterial> var0, ResourceKey<TrimMaterial> var1, Item var2, Style var3, float var4, Map<ArmorMaterials, String> var5) {
