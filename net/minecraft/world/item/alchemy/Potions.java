...
public class Potions {
   ...
   private static Potion register(String var0, Potion var1) {
      return (Potion)Registry.register(BuiltInRegistries.POTION, (String)var0, var1);
   }

   private static Potion register(ResourceKey<Potion> var0, Potion var1) {
      return (Potion)Registry.register(BuiltInRegistries.POTION, (ResourceKey)var0, var1);
   }

   static {
      EMPTY_ID = ResourceKey.create(Registries.POTION, new ResourceLocation("empty"));
