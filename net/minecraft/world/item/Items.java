...
public class Items {
   ...
   static {
      ...
      GRASS = registerBlock(Blocks.GRASS);
      ...
      CHISELED_BOOKSHELF = registerBlock(Blocks.CHISELED_BOOKSHELF);
      DECORATED_POT = registerBlock(new BlockItem(Blocks.DECORATED_POT, (new Item.Properties()).stacksTo(1)));
      ...
      SHULKER_BOX = registerBlock(new BlockItem(Blocks.SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      WHITE_SHULKER_BOX = registerBlock(new BlockItem(Blocks.WHITE_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      ORANGE_SHULKER_BOX = registerBlock(new BlockItem(Blocks.ORANGE_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      MAGENTA_SHULKER_BOX = registerBlock(new BlockItem(Blocks.MAGENTA_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      LIGHT_BLUE_SHULKER_BOX = registerBlock(new BlockItem(Blocks.LIGHT_BLUE_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      YELLOW_SHULKER_BOX = registerBlock(new BlockItem(Blocks.YELLOW_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      LIME_SHULKER_BOX = registerBlock(new BlockItem(Blocks.LIME_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      PINK_SHULKER_BOX = registerBlock(new BlockItem(Blocks.PINK_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      GRAY_SHULKER_BOX = registerBlock(new BlockItem(Blocks.GRAY_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      LIGHT_GRAY_SHULKER_BOX = registerBlock(new BlockItem(Blocks.LIGHT_GRAY_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      CYAN_SHULKER_BOX = registerBlock(new BlockItem(Blocks.CYAN_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      PURPLE_SHULKER_BOX = registerBlock(new BlockItem(Blocks.PURPLE_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      BLUE_SHULKER_BOX = registerBlock(new BlockItem(Blocks.BLUE_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      BROWN_SHULKER_BOX = registerBlock(new BlockItem(Blocks.BROWN_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      GREEN_SHULKER_BOX = registerBlock(new BlockItem(Blocks.GREEN_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      RED_SHULKER_BOX = registerBlock(new BlockItem(Blocks.RED_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      BLACK_SHULKER_BOX = registerBlock(new BlockItem(Blocks.BLACK_SHULKER_BOX, (new Item.Properties()).stacksTo(1)));
      ...
      HOPPER = registerBlock(Blocks.HOPPER);
      DISPENSER = registerBlock(Blocks.DISPENSER);
      DROPPER = registerBlock(Blocks.DROPPER);
      ...
      TRAPPED_CHEST = registerBlock(Blocks.TRAPPED_CHEST);
      ...
      TURTLE_HELMET = registerItem((String)"turtle_helmet", new ArmorItem(ArmorMaterials.TURTLE, ArmorItem.Type.HELMET, new Item.Properties()));
      SCUTE = registerItem("scute", new Item(new Item.Properties()));
      ...
      WOODEN_SWORD = registerItem((String)"wooden_sword", new SwordItem(Tiers.WOOD, 3, -2.4F, new Item.Properties()));
      WOODEN_SHOVEL = registerItem((String)"wooden_shovel", new ShovelItem(Tiers.WOOD, 1.5F, -3.0F, new Item.Properties()));
      WOODEN_PICKAXE = registerItem((String)"wooden_pickaxe", new PickaxeItem(Tiers.WOOD, 1, -2.8F, new Item.Properties()));
      WOODEN_AXE = registerItem((String)"wooden_axe", new AxeItem(Tiers.WOOD, 6.0F, -3.2F, new Item.Properties()));
      WOODEN_HOE = registerItem((String)"wooden_hoe", new HoeItem(Tiers.WOOD, 0, -3.0F, new Item.Properties()));
      STONE_SWORD = registerItem((String)"stone_sword", new SwordItem(Tiers.STONE, 3, -2.4F, new Item.Properties()));
      STONE_SHOVEL = registerItem((String)"stone_shovel", new ShovelItem(Tiers.STONE, 1.5F, -3.0F, new Item.Properties()));
      STONE_PICKAXE = registerItem((String)"stone_pickaxe", new PickaxeItem(Tiers.STONE, 1, -2.8F, new Item.Properties()));
      STONE_AXE = registerItem((String)"stone_axe", new AxeItem(Tiers.STONE, 7.0F, -3.2F, new Item.Properties()));
      STONE_HOE = registerItem((String)"stone_hoe", new HoeItem(Tiers.STONE, -1, -2.0F, new Item.Properties()));
      GOLDEN_SWORD = registerItem((String)"golden_sword", new SwordItem(Tiers.GOLD, 3, -2.4F, new Item.Properties()));
      GOLDEN_SHOVEL = registerItem((String)"golden_shovel", new ShovelItem(Tiers.GOLD, 1.5F, -3.0F, new Item.Properties()));
      GOLDEN_PICKAXE = registerItem((String)"golden_pickaxe", new PickaxeItem(Tiers.GOLD, 1, -2.8F, new Item.Properties()));
      GOLDEN_AXE = registerItem((String)"golden_axe", new AxeItem(Tiers.GOLD, 6.0F, -3.0F, new Item.Properties()));
      GOLDEN_HOE = registerItem((String)"golden_hoe", new HoeItem(Tiers.GOLD, 0, -3.0F, new Item.Properties()));
      IRON_SWORD = registerItem((String)"iron_sword", new SwordItem(Tiers.IRON, 3, -2.4F, new Item.Properties()));
      IRON_SHOVEL = registerItem((String)"iron_shovel", new ShovelItem(Tiers.IRON, 1.5F, -3.0F, new Item.Properties()));
      IRON_PICKAXE = registerItem((String)"iron_pickaxe", new PickaxeItem(Tiers.IRON, 1, -2.8F, new Item.Properties()));
      IRON_AXE = registerItem((String)"iron_axe", new AxeItem(Tiers.IRON, 6.0F, -3.1F, new Item.Properties()));
      IRON_HOE = registerItem((String)"iron_hoe", new HoeItem(Tiers.IRON, -2, -1.0F, new Item.Properties()));
      DIAMOND_SWORD = registerItem((String)"diamond_sword", new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
      DIAMOND_SHOVEL = registerItem((String)"diamond_shovel", new ShovelItem(Tiers.DIAMOND, 1.5F, -3.0F, new Item.Properties()));
      DIAMOND_PICKAXE = registerItem((String)"diamond_pickaxe", new PickaxeItem(Tiers.DIAMOND, 1, -2.8F, new Item.Properties()));
      DIAMOND_AXE = registerItem((String)"diamond_axe", new AxeItem(Tiers.DIAMOND, 5.0F, -3.0F, new Item.Properties()));
      DIAMOND_HOE = registerItem((String)"diamond_hoe", new HoeItem(Tiers.DIAMOND, -3, 0.0F, new Item.Properties()));
      NETHERITE_SWORD = registerItem((String)"netherite_sword", new SwordItem(Tiers.NETHERITE, 3, -2.4F, (new Item.Properties()).fireResistant()));
      NETHERITE_SHOVEL = registerItem((String)"netherite_shovel", new ShovelItem(Tiers.NETHERITE, 1.5F, -3.0F, (new Item.Properties()).fireResistant()));
      NETHERITE_PICKAXE = registerItem((String)"netherite_pickaxe", new PickaxeItem(Tiers.NETHERITE, 1, -2.8F, (new Item.Properties()).fireResistant()));
      NETHERITE_AXE = registerItem((String)"netherite_axe", new AxeItem(Tiers.NETHERITE, 5.0F, -3.0F, (new Item.Properties()).fireResistant()));
      NETHERITE_HOE = registerItem((String)"netherite_hoe", new HoeItem(Tiers.NETHERITE, -4, 0.0F, (new Item.Properties()).fireResistant()));
      ...
      LEATHER_HELMET = registerItem((String)"leather_helmet", new DyeableArmorItem(ArmorMaterials.LEATHER, ArmorItem.Type.HELMET, new Item.Properties()));
      LEATHER_CHESTPLATE = registerItem((String)"leather_chestplate", new DyeableArmorItem(ArmorMaterials.LEATHER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
      LEATHER_LEGGINGS = registerItem((String)"leather_leggings", new DyeableArmorItem(ArmorMaterials.LEATHER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
      LEATHER_BOOTS = registerItem((String)"leather_boots", new DyeableArmorItem(ArmorMaterials.LEATHER, ArmorItem.Type.BOOTS, new Item.Properties()));
      CHAINMAIL_HELMET = registerItem((String)"chainmail_helmet", new ArmorItem(ArmorMaterials.CHAIN, ArmorItem.Type.HELMET, new Item.Properties()));
      CHAINMAIL_CHESTPLATE = registerItem((String)"chainmail_chestplate", new ArmorItem(ArmorMaterials.CHAIN, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
      CHAINMAIL_LEGGINGS = registerItem((String)"chainmail_leggings", new ArmorItem(ArmorMaterials.CHAIN, ArmorItem.Type.LEGGINGS, new Item.Properties()));
      CHAINMAIL_BOOTS = registerItem((String)"chainmail_boots", new ArmorItem(ArmorMaterials.CHAIN, ArmorItem.Type.BOOTS, new Item.Properties()));
      IRON_HELMET = registerItem((String)"iron_helmet", new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.HELMET, new Item.Properties()));
      IRON_CHESTPLATE = registerItem((String)"iron_chestplate", new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
      IRON_LEGGINGS = registerItem((String)"iron_leggings", new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.LEGGINGS, new Item.Properties()));
      IRON_BOOTS = registerItem((String)"iron_boots", new ArmorItem(ArmorMaterials.IRON, ArmorItem.Type.BOOTS, new Item.Properties()));
      DIAMOND_HELMET = registerItem((String)"diamond_helmet", new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.HELMET, new Item.Properties()));
      DIAMOND_CHESTPLATE = registerItem((String)"diamond_chestplate", new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
      DIAMOND_LEGGINGS = registerItem((String)"diamond_leggings", new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.LEGGINGS, new Item.Properties()));
      DIAMOND_BOOTS = registerItem((String)"diamond_boots", new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.BOOTS, new Item.Properties()));
      GOLDEN_HELMET = registerItem((String)"golden_helmet", new ArmorItem(ArmorMaterials.GOLD, ArmorItem.Type.HELMET, new Item.Properties()));
      GOLDEN_CHESTPLATE = registerItem((String)"golden_chestplate", new ArmorItem(ArmorMaterials.GOLD, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
      GOLDEN_LEGGINGS = registerItem((String)"golden_leggings", new ArmorItem(ArmorMaterials.GOLD, ArmorItem.Type.LEGGINGS, new Item.Properties()));
      GOLDEN_BOOTS = registerItem((String)"golden_boots", new ArmorItem(ArmorMaterials.GOLD, ArmorItem.Type.BOOTS, new Item.Properties()));
      NETHERITE_HELMET = registerItem((String)"netherite_helmet", new ArmorItem(ArmorMaterials.NETHERITE, ArmorItem.Type.HELMET, (new Item.Properties()).fireResistant()));
      NETHERITE_CHESTPLATE = registerItem((String)"netherite_chestplate", new ArmorItem(ArmorMaterials.NETHERITE, ArmorItem.Type.CHESTPLATE, (new Item.Properties()).fireResistant()));
      NETHERITE_LEGGINGS = registerItem((String)"netherite_leggings", new ArmorItem(ArmorMaterials.NETHERITE, ArmorItem.Type.LEGGINGS, (new Item.Properties()).fireResistant()));
      NETHERITE_BOOTS = registerItem((String)"netherite_boots", new ArmorItem(ArmorMaterials.NETHERITE, ArmorItem.Type.BOOTS, (new Item.Properties()).fireResistant()));
      ...
      ENCHANTED_GOLDEN_APPLE = registerItem((String)"enchanted_golden_apple", new EnchantedGoldenAppleItem((new Item.Properties()).rarity(Rarity.EPIC).food(Foods.ENCHANTED_GOLDEN_APPLE)));
      ...
      PUFFERFISH_BUCKET = registerItem((String)"pufferfish_bucket", new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (new Item.Properties()).stacksTo(1)));
      SALMON_BUCKET = registerItem((String)"salmon_bucket", new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (new Item.Properties()).stacksTo(1)));
      COD_BUCKET = registerItem((String)"cod_bucket", new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (new Item.Properties()).stacksTo(1)));
      TROPICAL_FISH_BUCKET = registerItem((String)"tropical_fish_bucket", new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (new Item.Properties()).stacksTo(1)));
      AXOLOTL_BUCKET = registerItem((String)"axolotl_bucket", new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, (new Item.Properties()).stacksTo(1)));
      TADPOLE_BUCKET = registerItem((String)"tadpole_bucket", new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, (new Item.Properties()).stacksTo(1)));
      ...
      BUNDLE = registerItem((String)"bundle", new BundleItem((new Item.Properties()).stacksTo(1)));
      ...
      SHEARS = registerItem((String)"shears", new ShearsItem((new Item.Properties()).durability(238)));
      ...
      PUMPKIN_SEEDS = registerItem((String)"pumpkin_seeds", new ItemNameBlockItem(Blocks.PUMPKIN_STEM, new Item.Properties()));
      MELON_SEEDS = registerItem((String)"melon_seeds", new ItemNameBlockItem(Blocks.MELON_STEM, new Item.Properties()));
      ...
      POTION = registerItem((String)"potion", new PotionItem((new Item.Properties()).stacksTo(1)));
      ...
      BREWING_STAND = registerBlock(Blocks.BREWING_STAND);
      ...
      EXPERIENCE_BOTTLE = registerItem((String)"experience_bottle", new ExperienceBottleItem((new Item.Properties()).rarity(Rarity.UNCOMMON)));
      FIRE_CHARGE = registerItem((String)"fire_charge", new FireChargeItem(new Item.Properties()));
      WRITABLE_BOOK = registerItem((String)"writable_book", new WritableBookItem((new Item.Properties()).stacksTo(1)));
      ...
      NETHER_STAR = registerItem((String)"nether_star", new SimpleFoiledItem((new Item.Properties()).rarity(Rarity.UNCOMMON)));
      PUMPKIN_PIE = registerItem("pumpkin_pie", new Item((new Item.Properties()).food(Foods.PUMPKIN_PIE)));
      FIREWORK_ROCKET = registerItem((String)"firework_rocket", new FireworkRocketItem(new Item.Properties()));
      ...
      IRON_HORSE_ARMOR = registerItem((String)"iron_horse_armor", new HorseArmorItem(5, "iron", (new Item.Properties()).stacksTo(1)));
      GOLDEN_HORSE_ARMOR = registerItem((String)"golden_horse_armor", new HorseArmorItem(7, "gold", (new Item.Properties()).stacksTo(1)));
      DIAMOND_HORSE_ARMOR = registerItem((String)"diamond_horse_armor", new HorseArmorItem(11, "diamond", (new Item.Properties()).stacksTo(1)));
      LEATHER_HORSE_ARMOR = registerItem((String)"leather_horse_armor", new DyeableHorseArmorItem(3, "leather", (new Item.Properties()).stacksTo(1)));
      ...
      WHITE_BANNER = registerItem((String)"white_banner", new BannerItem(Blocks.WHITE_BANNER, Blocks.WHITE_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      ORANGE_BANNER = registerItem((String)"orange_banner", new BannerItem(Blocks.ORANGE_BANNER, Blocks.ORANGE_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      MAGENTA_BANNER = registerItem((String)"magenta_banner", new BannerItem(Blocks.MAGENTA_BANNER, Blocks.MAGENTA_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      LIGHT_BLUE_BANNER = registerItem((String)"light_blue_banner", new BannerItem(Blocks.LIGHT_BLUE_BANNER, Blocks.LIGHT_BLUE_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      YELLOW_BANNER = registerItem((String)"yellow_banner", new BannerItem(Blocks.YELLOW_BANNER, Blocks.YELLOW_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      LIME_BANNER = registerItem((String)"lime_banner", new BannerItem(Blocks.LIME_BANNER, Blocks.LIME_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      PINK_BANNER = registerItem((String)"pink_banner", new BannerItem(Blocks.PINK_BANNER, Blocks.PINK_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      GRAY_BANNER = registerItem((String)"gray_banner", new BannerItem(Blocks.GRAY_BANNER, Blocks.GRAY_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      LIGHT_GRAY_BANNER = registerItem((String)"light_gray_banner", new BannerItem(Blocks.LIGHT_GRAY_BANNER, Blocks.LIGHT_GRAY_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      CYAN_BANNER = registerItem((String)"cyan_banner", new BannerItem(Blocks.CYAN_BANNER, Blocks.CYAN_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      PURPLE_BANNER = registerItem((String)"purple_banner", new BannerItem(Blocks.PURPLE_BANNER, Blocks.PURPLE_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      BLUE_BANNER = registerItem((String)"blue_banner", new BannerItem(Blocks.BLUE_BANNER, Blocks.BLUE_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      BROWN_BANNER = registerItem((String)"brown_banner", new BannerItem(Blocks.BROWN_BANNER, Blocks.BROWN_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      GREEN_BANNER = registerItem((String)"green_banner", new BannerItem(Blocks.GREEN_BANNER, Blocks.GREEN_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      RED_BANNER = registerItem((String)"red_banner", new BannerItem(Blocks.RED_BANNER, Blocks.RED_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      BLACK_BANNER = registerItem((String)"black_banner", new BannerItem(Blocks.BLACK_BANNER, Blocks.BLACK_WALL_BANNER, (new Item.Properties()).stacksTo(16)));
      END_CRYSTAL = registerItem((String)"end_crystal", new EndCrystalItem((new Item.Properties()).rarity(Rarity.RARE)));
      ...
      SPLASH_POTION = registerItem((String)"splash_potion", new SplashPotionItem((new Item.Properties()).stacksTo(1)));
      SPECTRAL_ARROW = registerItem((String)"spectral_arrow", new SpectralArrowItem(new Item.Properties()));
      TIPPED_ARROW = registerItem((String)"tipped_arrow", new TippedArrowItem(new Item.Properties()));
      LINGERING_POTION = registerItem((String)"lingering_potion", new LingeringPotionItem((new Item.Properties()).stacksTo(1)));
      SHIELD = registerItem((String)"shield", new ShieldItem((new Item.Properties()).durability(336)));
      ...
      TRIDENT = registerItem((String)"trident", new TridentItem((new Item.Properties()).durability(250)));
      ...
      CROSSBOW = registerItem((String)"crossbow", new CrossbowItem((new Item.Properties()).stacksTo(1).durability(465)));
      ...
      BARREL = registerBlock(Blocks.BARREL);
      SMOKER = registerBlock(Blocks.SMOKER);
      BLAST_FURNACE = registerBlock(Blocks.BLAST_FURNACE);
      ...
      CAMPFIRE = registerBlock(Blocks.CAMPFIRE);
      SOUL_CAMPFIRE = registerBlock(Blocks.SOUL_CAMPFIRE);
      ...
      BEE_NEST = registerBlock(Blocks.BEE_NEST);
      BEEHIVE = registerBlock(Blocks.BEEHIVE);
