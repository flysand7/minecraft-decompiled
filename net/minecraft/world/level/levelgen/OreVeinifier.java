...
public final class OreVeinifier {
   ...
   protected static NoiseChunk.BlockStateFiller create(DensityFunction var0, DensityFunction var1, DensityFunction var2, PositionalRandomFactory var3) {
      ...
      return (var5) -> {
         ...
         OreVeinifier.VeinType var9 = var6 > 0.0D ? OreVeinifier.VeinType.COPPER : OreVeinifier.VeinType.IRON;
         double var10 = Math.abs(var6);
         int var12 = var9.maxY - var8;
         int var13 = var8 - var9.minY;
         if (var13 >= 0 && var12 >= 0) {
            int var14 = Math.min(var12, var13);
            double var15 = Mth.clampedMap((double)var14, 0.0D, 20.0D, -0.2D, 0.0D);
            if (var10 + var15 < 0.4000000059604645D) {
               return var4;
            } else {
               RandomSource var17 = var3.at(var5.blockX(), var8, var5.blockZ());
               if (var17.nextFloat() > 0.7F) {
                  return var4;
               } else if (var1.compute(var5) >= 0.0D) {
                  return var4;
               } else {
                  double var18 = Mth.clampedMap(var10, 0.4000000059604645D, 0.6000000238418579D, 0.10000000149011612D, 0.30000001192092896D);
                  if ((double)var17.nextFloat() < var18 && var2.compute(var5) > -0.30000001192092896D) {
