...
public class CanyonWorldCarver extends WorldCarver<CanyonCarverConfiguration> {
   ...
   // $FF: synthetic method
   // $FF: bridge method
   public boolean isStartChunk(CarverConfiguration var1, RandomSource var2) {
      return this.isStartChunk((CanyonCarverConfiguration)var1, var2);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public boolean carve(CarvingContext var1, CarverConfiguration var2, ChunkAccess var3, Function var4, RandomSource var5, Aquifer var6, ChunkPos var7, CarvingMask var8) {
      return this.carve(var1, (CanyonCarverConfiguration)var2, var3, var4, var5, var6, var7, var8);
   }
}
