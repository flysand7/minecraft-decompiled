...
public class EndCityPieces {
   ...
   static final EndCityPieces.SectionGenerator HOUSE_TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(StructureTemplateManager var1, int var2, EndCityPieces.EndCityPiece var3, BlockPos var4, List<StructurePiece> var5, RandomSource var6) {
         if (var2 > 8) {
            return false;
         } else {
   ...
   static EndCityPieces.EndCityPiece addPiece(StructureTemplateManager var0, EndCityPieces.EndCityPiece var1, BlockPos var2, String var3, Rotation var4, boolean var5) {
   ...
   static boolean recursiveChildren(StructureTemplateManager var0, EndCityPieces.SectionGenerator var1, int var2, EndCityPieces.EndCityPiece var3, BlockPos var4, List<StructurePiece> var5, RandomSource var6) {
      if (var2 > 8) {
         return false;
      } else {
