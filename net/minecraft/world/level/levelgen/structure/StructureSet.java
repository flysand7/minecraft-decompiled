...
public record StructureSet(List<StructureSet.StructureSelectionEntry> c, StructurePlacement d) {
   ...
   public static record StructureSelectionEntry(Holder<Structure> b, int c) {
      ...
      public static final Codec<StructureSet.StructureSelectionEntry> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(Structure.CODEC.fieldOf("structure").forGetter(StructureSet.StructureSelectionEntry::structure), ExtraCodecs.POSITIVE_INT.fieldOf("weight").forGetter(StructureSet.StructureSelectionEntry::weight)).apply(var0, StructureSet.StructureSelectionEntry::new);
      });
