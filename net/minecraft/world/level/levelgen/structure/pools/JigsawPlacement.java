...
public class JigsawPlacement {
   ...
   public static Optional<Structure.GenerationStub> addPieces(Structure.GenerationContext var0, Holder<StructureTemplatePool> var1, Optional<ResourceLocation> var2, int var3, BlockPos var4, boolean var5, Optional<Heightmap.Types> var6, int var7) {
      ...
      if (var16 == EmptyPoolElement.INSTANCE) {
         ...
         if (var2.isPresent()) {
            ...
            if (var19.isEmpty()) {
               LOGGER.error("No starting jigsaw {} found in start pool {}", var18, var1.unwrapKey().map((var0x) -> {
   ...
   private static void addPieces(RandomState var0, int var1, boolean var2, ChunkGenerator var3, StructureTemplateManager var4, LevelHeightAccessor var5, RandomSource var6, Registry<StructureTemplatePool> var7, PoolElementStructurePiece var8, List<PoolElementStructurePiece> var9, VoxelShape var10) {
      ...
      while(!var11.placing.isEmpty()) {
         JigsawPlacement.PieceState var12 = (JigsawPlacement.PieceState)var11.placing.removeFirst();
               ...
               if (var23.isEmpty()) {
                  ...
                  if (((StructureTemplatePool)var24.value()).size() == 0 && !var24.is(Pools.EMPTY)) {
                     ...
                     if (((StructureTemplatePool)var25.value()).size() == 0 && !var25.is(Pools.EMPTY)) {
                        JigsawPlacement.LOGGER.warn("Empty or non-existent fallback pool: {}", var25.unwrapKey().map((var0) -> {
                        ...
                        while(var29.hasNext()) {
                           ...
                           while(var31.hasNext()) {
                              ...
                              if (var4 && var34.getYSpan() <= 16) {
                                 var35 = var33.stream().mapToInt((var2x) -> {
                                    if (!var34.isInside(var2x.pos().relative(JigsawBlock.getFrontFacing(var2x.state())))) {
                                       ...
                                       ResourceKey var3 = readPoolName(var2x);
                                       Optional var4 = this.pools.getHolder(var3);
                                       Optional var5 = var4.map((var0) -> {
                              ...
                              } while(Shapes.joinIsNotEmpty((VoxelShape)var26.getValue(), Shapes.create(AABB.of(var48).deflate(0.25D)), BooleanOp.ONLY_SECOND));
