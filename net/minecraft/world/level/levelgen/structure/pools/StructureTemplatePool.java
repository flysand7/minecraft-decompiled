...
public class StructureTemplatePool {
   ...
   public static final Codec<StructureTemplatePool> DIRECT_CODEC = RecordCodecBuilder.create((var0) -> {
      ...
      return var0.group(ExtraCodecs.lazyInitializedCodec(var10001::getValue).fieldOf("fallback").forGetter(StructureTemplatePool::getFallback), Codec.mapPair(StructurePoolElement.CODEC.fieldOf("element"), Codec.intRange(1, 150).fieldOf("weight")).codec().listOf().fieldOf("elements").forGetter((var0x) -> {
   ...
   public StructureTemplatePool(Holder<StructureTemplatePool> var1, List<Pair<Function<StructureTemplatePool.Projection, ? extends StructurePoolElement>, Integer>> var2, StructureTemplatePool.Projection var3) {
   ...
   public static enum Projection implements StringRepresentable {
      ...
      public static StructureTemplatePool.Projection byName(String var0) {
         return (StructureTemplatePool.Projection)CODEC.byName(var0);
      }
