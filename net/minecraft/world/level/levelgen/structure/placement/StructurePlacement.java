...
public abstract class StructurePlacement {
   ...
   protected static <S extends StructurePlacement> P5<Mu<S>, Vec3i, StructurePlacement.FrequencyReductionMethod, Float, Integer, Optional<StructurePlacement.ExclusionZone>> placementCodec(Instance<S> var0) {
   ...
   protected StructurePlacement(Vec3i var1, StructurePlacement.FrequencyReductionMethod var2, float var3, int var4, Optional<StructurePlacement.ExclusionZone> var5) {
   ...
   public static enum FrequencyReductionMethod implements StringRepresentable {
      ...
      // $FF: synthetic method
      private static StructurePlacement.FrequencyReductionMethod[] $values() {
         return new StructurePlacement.FrequencyReductionMethod[]{DEFAULT, LEGACY_TYPE_1, LEGACY_TYPE_2, LEGACY_TYPE_3};
      }
   }
   ...
   public static record ExclusionZone(Holder<StructureSet> b, int c) {
      ...
      public static final Codec<StructurePlacement.ExclusionZone> CODEC = RecordCodecBuilder.create((var0) -> {
         return var0.group(RegistryFileCodec.create(Registries.STRUCTURE_SET, StructureSet.DIRECT_CODEC, false).fieldOf("other_set").forGetter(StructurePlacement.ExclusionZone::otherSet), Codec.intRange(1, 16).fieldOf("chunk_count").forGetter(StructurePlacement.ExclusionZone::chunkCount)).apply(var0, StructurePlacement.ExclusionZone::new);
      });
