...
public class LargeDripstoneFeature extends Feature<LargeDripstoneConfiguration> {
   ...
   private static LargeDripstoneFeature.LargeDripstone makeDripstone(BlockPos var0, boolean var1, RandomSource var2, int var3, FloatProvider var4, FloatProvider var5) {
            ...
            for(int var5 = -this.radius; var5 <= this.radius; ++var5) {
               ...
               if (!(var6 > (float)this.radius)) {
                  ...
                  if (var7 > 0) {
                     ...
                     boolean var9 = false;
                     int var10 = this.pointingUp ? var1.getHeight(Heightmap.Types.WORLD_SURFACE_WG, var8.getX(), var8.getZ()) : Integer.MAX_VALUE;
