...
public class CherryTrunkPlacer extends TrunkPlacer {
   ...
   static {
      BRANCH_START_CODEC = ExtraCodecs.validate(UniformInt.CODEC, (var0) -> {
      ...
      CODEC = RecordCodecBuilder.create((var0) -> {
         ...
         }), IntProvider.codec(-16, 0, BRANCH_START_CODEC).fieldOf("branch_start_offset_from_top").forGetter((var0x) -> {
