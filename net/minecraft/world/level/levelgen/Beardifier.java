...
public class Beardifier implements DensityFunctions.BeardifierOrMarker {
   ...
   public double compute(DensityFunction.FunctionContext var1) {
      ...
      int var10;
      double var10001;
      for(var5 = 0.0D; this.pieceIterator.hasNext(); var5 += var10001) {
         ...
         case BEARD_THIN:
         case BEARD_BOX:
            var10001 = getBeardContribution(var10, var14, var11, var13) * 0.8D;
            break;
         default:
            throw new IncompatibleClassChangeError();
         }
      ...
      while(this.junctionIterator.hasNext()) {
         ...
         var5 += getBeardContribution(var16, var9, var10, var9) * 0.4D;
      }
