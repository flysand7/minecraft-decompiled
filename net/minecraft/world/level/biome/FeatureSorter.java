...
public class FeatureSorter {
   ...
   public static <T> List<FeatureSorter.StepFeatureData> buildFeaturesPerStep(List<T> var0, Function<T, List<HolderSet<PlacedFeature>>> var1, boolean var2) {
      ...
      while(var8.hasNext()) {
         ...
         for(var12 = 0; var12 < var11.size(); ++var12) {
            ...
            while(var13.hasNext()) {
               ...
               var10.add(new FeatureData(var3.computeIfAbsent(var15, (var1x) -> {
         ...
         for(var12 = 0; var12 < var10.size(); ++var12) {
            Set var24 = (Set)var6.computeIfAbsent((FeatureData)var10.get(var12), (var1x) -> {
               return new TreeSet(var5);
            });
            if (var12 < var10.size() - 1) {
               var24.add((FeatureData)var10.get(var12 + 1));
            }
         }
      }
      ...
      while(var21.hasNext()) {
         FeatureData var23 = (FeatureData)var21.next();
         if (!var20.isEmpty()) {
      ...
      for(var12 = 0; var12 < var7; ++var12) {
         ...
         var22.add(new FeatureSorter.StepFeatureData(var27));
      }
