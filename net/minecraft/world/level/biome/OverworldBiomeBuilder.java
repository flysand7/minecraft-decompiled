...
public final class OverworldBiomeBuilder {
   ...
   private void addDebugBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> var1) {
      ...
      int var12;
      float var13;
      if (var7 instanceof CubicSpline.Multipoint) {
         CubicSpline.Multipoint var8 = (CubicSpline.Multipoint)var7;
      ...
      if (var14 instanceof CubicSpline.Multipoint) {
         CubicSpline.Multipoint var15 = (CubicSpline.Multipoint)var14;
   ...
   public static boolean isDeepDarkRegion(DensityFunction var0, DensityFunction var1, DensityFunction.FunctionContext var2) {
      return var0.compute(var2) < -0.22499999403953552D && var1.compute(var2) > 0.8999999761581421D;
   }
