...
public class Climate {
   ...
   public static record Sampler(DensityFunction a, DensityFunction b, DensityFunction c, DensityFunction d, DensityFunction e, DensityFunction f, List<Climate.ParameterPoint> g) {
      ...
      public Sampler(DensityFunction var1, DensityFunction var2, DensityFunction var3, DensityFunction var4, DensityFunction var5, DensityFunction var6, List<Climate.ParameterPoint> var7) {
         this.temperature = var1;
         this.humidity = var2;
         this.continentalness = var3;
         this.erosion = var4;
   ...
   protected static final class RTree<T> {
      ...
      private static <T> List<Climate.RTree.SubTree<T>> bucketize(List<? extends Climate.RTree.Node<T>> var0) {
         ...
         int var3 = (int)Math.pow(6.0D, Math.floor(Math.log((double)var0.size() - 0.01D) / Math.log(6.0D)));
      ...
      private static final class SubTree<T> extends Climate.RTree.Node<T> {
         ...
         protected Climate.RTree.Leaf<T> search(long[] var1, @Nullable Climate.RTree.Leaf<T> var2, Climate.DistanceMetric<T> var3) {
            long var4 = var2 == null ? Long.MAX_VALUE : var3.distance(var2, var1);
