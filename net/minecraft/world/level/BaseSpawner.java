      ...
      if (this.isNearPlayer(var1, var2)) {
         ...
         if (this.spawnDelay > 0) {
            ...
            for(int var6 = 0; var6 < this.spawnCount; ++var6) {
               ...
               int var10 = var9.size();
               double var11 = var10 >= 1 ? var9.getDouble(0) : (double)var2.getX() + (var4.nextDouble() - var4.nextDouble()) * (double)this.spawnRange + 0.5D;
               double var13 = var10 >= 2 ? var9.getDouble(1) : (double)(var2.getY() + var4.nextInt(3) - 1);
               double var15 = var10 >= 3 ? var9.getDouble(2) : (double)var2.getZ() + (var4.nextDouble() - var4.nextDouble()) * (double)this.spawnRange + 0.5D;
               if (var1.noCollision(((EntityType)var8.get()).getAABB(var11, var13, var15))) {
                  ...
                  if (var5.getCustomSpawnRules().isPresent()) {
                     ...
                     if (!var18.blockLightLimit().isValueInRange(var1.getBrightness(LightLayer.BLOCK, var17)) || !var18.skyLightLimit().isValueInRange(var1.getBrightness(LightLayer.SKY, var17))) {
                        continue;
                     }
                  ...
                  int var19 = var1.getEntitiesOfClass(var21.getClass(), (new AABB((double)var2.getX(), (double)var2.getY(), (double)var2.getZ(), (double)(var2.getX() + 1), (double)(var2.getY() + 1), (double)(var2.getZ() + 1))).inflate((double)this.spawnRange)).size();
                  ...
                  if (var21 instanceof Mob) {
                     ...
                     if (var5.getEntityToSpawn().size() == 1 && var5.getEntityToSpawn().contains("id", 8)) {
                        ((Mob)var21).finalizeSpawn(var1, var1.getCurrentDifficultyAt(var21.blockPosition()), MobSpawnType.SPAWNER, (SpawnGroupData)null, (CompoundTag)null);
                     }
                  }
