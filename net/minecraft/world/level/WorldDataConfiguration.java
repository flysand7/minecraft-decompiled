...
public record WorldDataConfiguration(DataPackConfig d, FeatureFlagSet e) {
   ...
   public static final Codec<WorldDataConfiguration> CODEC = RecordCodecBuilder.create((var0) -> {
      return var0.group(DataPackConfig.CODEC.optionalFieldOf("DataPacks", DataPackConfig.DEFAULT).forGetter(WorldDataConfiguration::dataPacks), FeatureFlags.CODEC.optionalFieldOf("enabled_features", FeatureFlags.DEFAULT_FLAGS).forGetter(WorldDataConfiguration::enabledFeatures)).apply(var0, WorldDataConfiguration::new);
   });
