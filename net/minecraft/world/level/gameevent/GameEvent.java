...
public class GameEvent {
   ...
   private static GameEvent register(String var0, int var1) {
      return (GameEvent)Registry.register(BuiltInRegistries.GAME_EVENT, (String)var0, new GameEvent(var0, var1));
   }
   ...
   public static final class ListenerInfo implements Comparable<GameEvent.ListenerInfo> {
      ...
      public int compareTo(Object var1) {
         return this.compareTo((GameEvent.ListenerInfo)var1);
      }
   }
   ...
   public static record Context(@Nullable Entity a, @Nullable BlockState b) {
      ...
      public static GameEvent.Context of(@Nullable Entity var0) {
         return new GameEvent.Context(var0, (BlockState)null);
      }

      public static GameEvent.Context of(@Nullable BlockState var0) {
         return new GameEvent.Context((Entity)null, var0);
      }
