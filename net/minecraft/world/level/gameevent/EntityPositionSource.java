...
public class EntityPositionSource implements PositionSource {
   ...
   public Optional<Vec3> getPosition(Level var1) {
      ...
      return this.entityOrUuidOrId.left().map((var1x) -> {
         return var1x.position().add(0.0D, (double)this.yOffset, 0.0D);
      });
   }
   ...
   public static class Type implements PositionSourceType<EntityPositionSource> {
      ...
      // $FF: synthetic method
      // $FF: bridge method
      public void write(FriendlyByteBuf var1, PositionSource var2) {
         this.write(var1, (EntityPositionSource)var2);
      }
