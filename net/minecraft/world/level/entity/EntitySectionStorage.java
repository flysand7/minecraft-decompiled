...
public class EntitySectionStorage<T extends EntityAccess> {
   ...
   public void forEachAccessibleNonEmptySection(AABB var1, AbortableIterationConsumer<EntitySection<T>> var2) {
      boolean var3 = true;
      int var4 = SectionPos.posToSectionCoord(var1.minX - 2.0D);
      int var5 = SectionPos.posToSectionCoord(var1.minY - 4.0D);
      int var6 = SectionPos.posToSectionCoord(var1.minZ - 2.0D);
      int var7 = SectionPos.posToSectionCoord(var1.maxX + 2.0D);
      int var8 = SectionPos.posToSectionCoord(var1.maxY + 0.0D);
      int var9 = SectionPos.posToSectionCoord(var1.maxZ + 2.0D);
