...
public class SectionStorage<R> implements AutoCloseable {
   ...
   private void readColumn(ChunkPos var1) {
      ...
      RegistryOps var3 = RegistryOps.create(NbtOps.INSTANCE, (HolderLookup.Provider)this.registryAccess);
   ...
   private CompletableFuture<Optional<CompoundTag>> tryRead(ChunkPos var1) {
      return this.worker.loadAsync(var1).exceptionally((var1x) -> {
         if (var1x instanceof IOException) {
            IOException var2 = (IOException)var1x;
   ...
   private void writeColumn(ChunkPos var1) {
      RegistryOps var2 = RegistryOps.create(NbtOps.INSTANCE, (HolderLookup.Provider)this.registryAccess);
