...
public class PalettedContainer<T> implements PaletteResize<T>, PalettedContainerRO<T> {
   ...
   private static <T, C extends PalettedContainerRO<T>> Codec<C> codec(IdMap<T> var0, Codec<T> var1, PalettedContainer.Strategy var2, T var3, PalettedContainerRO.Unpacker<T, C> var4) {
