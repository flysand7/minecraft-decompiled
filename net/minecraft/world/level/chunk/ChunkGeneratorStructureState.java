   ...
   private CompletableFuture<List<ChunkPos>> generateRingPositions(Holder<StructureSet> var1, ConcentricRingsStructurePlacement var2) {
      if (var2.count() == 0) {
         ...
         for(int var14 = 0; var14 < var5; ++var14) {
            double var15 = (double)(4 * var4 + var4 * var13 * 6) + (var9.nextDouble() - 0.5D) * (double)var4 * 2.5D;
            ...
            var10 += 6.283185307179586D / (double)var7;
            ++var12;
            if (var12 == var7) {
               ++var13;
               var12 = 0;
         ...
         return Util.sequence(var6).thenApply((var2x) -> {
            double var3x = (double)var3.stop().elapsed(TimeUnit.MILLISECONDS) / 1000.0D;
