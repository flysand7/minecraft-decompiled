...
public class GameRules {
   ...
   public static class BooleanValue extends GameRules.Value<GameRules.BooleanValue> {
      ...
      // $FF: synthetic method
      // $FF: bridge method
      public void setFrom(GameRules.Value var1, @Nullable MinecraftServer var2) {
         this.setFrom((GameRules.BooleanValue)var1, var2);
      }
   ...
   public static class IntegerValue extends GameRules.Value<GameRules.IntegerValue> {
      ...
      // $FF: bridge method
      public void setFrom(GameRules.Value var1, @Nullable MinecraftServer var2) {
         this.setFrom((GameRules.IntegerValue)var1, var2);
      }
