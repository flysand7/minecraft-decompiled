...
public class SkyLightSectionStorage extends LayerLightSectionStorage<SkyLightSectionStorage.SkyDataLayerStorageMap> {
   ...
   protected void onNodeRemoved(long var1) {
      ...
      if (((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).topSections.get(var3) == var5 + 1) {
         long var6;
         ...
         if (this.storingLightForSection(var6)) {
            ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).topSections.put(var3, var5 + 1);
         } else {
   ...
   protected DataLayer createDataLayer(long var1) {
      ...
      if (var3 != null) {
         ...
         int var4 = ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).topSections.get(SectionPos.getZeroNode(var1));
         if (var4 != ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY && SectionPos.y(var1) < var4) {
            DataLayer var7;
   ...
   protected int getTopSectionY(long var1) {
      return ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).topSections.get(var1);
   }

   protected int getBottomSectionY() {
      return ((SkyLightSectionStorage.SkyDataLayerStorageMap)this.updatingSectionData).currentLowestY;
   }
