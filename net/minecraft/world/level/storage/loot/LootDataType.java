...
public class LootDataType<T> {
   ...
   private LootDataType(Gson var1, BiFunction<Gson, String, BiFunction<ResourceLocation, JsonElement, Optional<T>>> var2, String var3, LootDataType.Validator<T> var4) {
      this.parser = var1;
      this.directory = var3;
      this.validator = var4;
      this.topDeserializer = (BiFunction)var2.apply(var1, var3);
   }
   ...
   public Optional<T> deserialize(ResourceLocation var1, JsonElement var2) {
      return (Optional)this.topDeserializer.apply(var1, var2);
   }
   ...
   private static <T> BiFunction<Gson, String, BiFunction<ResourceLocation, JsonElement, Optional<T>>> createSingleOrMultipleDeserialiser(Class<T> var0, Function<T[], T> var1) {
         ...
         return (var5, var6) -> {
            try {
               if (var6.isJsonArray()) {
                  ...
                  return Optional.of(var3.fromJson(var6, var0));
               }
   ...
   private static <T extends LootContextUser> LootDataType.Validator<T> createSimpleValidator() {
      return (var0, var1, var2) -> {
         var2.validate(var0.enterElement("{" + var1.type().directory + ":" + var1.location() + "}", var1));
      };
   }

   private static LootDataType.Validator<LootTable> createLootTableValidator() {
      return (var0, var1, var2) -> {
         var2.validate(var0.setParams(var2.getParamSet()).enterElement("{" + var1.type().directory + ":" + var1.location() + "}", var1));
      };
   }
