...
public class LootTableReference extends LootPoolSingletonContainer {
   ...
   public static class Serializer extends LootPoolSingletonContainer.Serializer<LootTableReference> {
      ...
      // $FF: synthetic method
      // $FF: bridge method
      public void serializeCustom(JsonObject var1, LootPoolSingletonContainer var2, JsonSerializationContext var3) {
         this.serializeCustom(var1, (LootTableReference)var2, var3);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void serializeCustom(JsonObject var1, LootPoolEntryContainer var2, JsonSerializationContext var3) {
         this.serializeCustom(var1, (LootTableReference)var2, var3);
      }
   }
}
