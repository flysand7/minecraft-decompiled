...
public class LootParams {
   ...
   public void addDynamicDrops(ResourceLocation var1, Consumer<ItemStack> var2) {
      LootParams.DynamicDrop var3 = (LootParams.DynamicDrop)this.dynamicDrops.get(var1);
      if (var3 != null) {
         var3.add(var2);
      }
   ...
   public static class Builder {
      ...
      public LootParams.Builder withDynamicDrop(ResourceLocation var1, LootParams.DynamicDrop var2) {
         LootParams.DynamicDrop var3 = (LootParams.DynamicDrop)this.dynamicDrops.put(var1, var2);
         if (var3 != null) {
