...
public class FunctionReference extends LootItemConditionalFunction {
   ...
   public void validate(ValidationContext var1) {
      ...
      if (var1.hasVisitedElement(var2)) {
         ...
         var1.resolver().getElementOptional(var2).ifPresentOrElse((var3) -> {
            ...
            var1.reportProblem("Unknown function table called " + this.name);
         });
      }
   }

   protected ItemStack run(ItemStack var1, LootContext var2) {
      LootItemFunction var3 = (LootItemFunction)var2.getResolver().getElement(LootDataType.MODIFIER, this.name);
      if (var3 == null) {
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<FunctionReference> {
      ...
      public void serialize(JsonObject var1, LootItemConditionalFunction var2, JsonSerializationContext var3) {
         this.serialize(var1, (FunctionReference)var2, var3);
      }
