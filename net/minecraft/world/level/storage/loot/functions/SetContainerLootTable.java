...
public class SetContainerLootTable extends LootItemConditionalFunction {
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<SetContainerLootTable> {
      ...
      public SetContainerLootTable deserialize(JsonObject var1, JsonDeserializationContext var2, LootItemCondition[] var3) {
         ...
         BlockEntityType var8 = (BlockEntityType)BuiltInRegistries.BLOCK_ENTITY_TYPE.getOptional(var7).orElseThrow(() -> {
      ...
      public void serialize(JsonObject var1, LootItemConditionalFunction var2, JsonSerializationContext var3) {
         this.serialize(var1, (SetContainerLootTable)var2, var3);
      }
