...
public class SetContainerContents extends LootItemConditionalFunction {
   ...
   public static class Serializer extends LootItemConditionalFunction.Serializer<SetContainerContents> {
      ...
      public SetContainerContents deserialize(JsonObject var1, JsonDeserializationContext var2, LootItemCondition[] var3) {
         ...
         BlockEntityType var6 = (BlockEntityType)BuiltInRegistries.BLOCK_ENTITY_TYPE.getOptional(var5).orElseThrow(() -> {
      ...
      public void serialize(JsonObject var1, LootItemConditionalFunction var2, JsonSerializationContext var3) {
         this.serialize(var1, (SetContainerContents)var2, var3);
      }
