...
public class LootContextParamSets {
   ...
   public static final LootContextParamSet ARCHAEOLOGY = register("archaeology", (var0) -> {
      var0.required(LootContextParams.ORIGIN).optional(LootContextParams.THIS_ENTITY);
   });
   ...
   public static final LootContextParamSet ADVANCEMENT_LOCATION = register("advancement_location", (var0) -> {
