...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
   ...
   private BlockPathTypes getCachedBlockPathType(int var1, int var2, int var3) {
      return (BlockPathTypes)this.pathTypeByPosCache.computeIfAbsent(BlockPos.asLong(var1, var2, var3), (var4) -> {
         return this.getBlockPathType(this.level, var1, var2, var3, this.mob);
      });
   }
   ...
   public BlockPathTypes getBlockPathType(BlockGetter var1, int var2, int var3, int var4, Mob var5) {
      ...
      if (var6.contains(BlockPathTypes.FENCE)) {
         ...
         while(var10.hasNext()) {
            BlockPathTypes var11 = (BlockPathTypes)var10.next();
         ...
         if (var7 == BlockPathTypes.OPEN && var5.getPathfindingMalus(var9) == 0.0F) {
   ...
   private Iterable<BlockPos> iteratePathfindingStartNodeCandidatePositions(Mob var1) {
      ...
      boolean var4 = var3.getSize() < 1.0D;
      if (!var4) {
         return List.of(BlockPos.containing(var3.minX, (double)var1.getBlockY(), var3.minZ), BlockPos.containing(var3.minX, (double)var1.getBlockY(), var3.maxZ), BlockPos.containing(var3.maxX, (double)var1.getBlockY(), var3.minZ), BlockPos.containing(var3.maxX, (double)var1.getBlockY(), var3.maxZ));
      } else {
         double var5 = Math.max(0.0D, (1.5D - var3.getZsize()) / 2.0D);
         double var7 = Math.max(0.0D, (1.5D - var3.getXsize()) / 2.0D);
         double var9 = Math.max(0.0D, (1.5D - var3.getYsize()) / 2.0D);
         AABB var11 = var3.inflate(var7, var9, var5);
         return BlockPos.randomBetweenClosed(var1.getRandom(), 10, Mth.floor(var11.minX), Mth.floor(var11.minY), Mth.floor(var11.minZ), Mth.floor(var11.maxX), Mth.floor(var11.maxY), Mth.floor(var11.maxZ));
      }
   }
}
