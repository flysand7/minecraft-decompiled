...
public class BlockCollisions<T> extends AbstractIterator<T> {
   ...
   public BlockCollisions(CollisionGetter var1, @Nullable Entity var2, AABB var3, boolean var4, BiFunction<BlockPos.MutableBlockPos, VoxelShape, T> var5) {
      ...
      int var6 = Mth.floor(var3.minX - 1.0E-7D) - 1;
      int var7 = Mth.floor(var3.maxX + 1.0E-7D) + 1;
      int var8 = Mth.floor(var3.minY - 1.0E-7D) - 1;
      int var9 = Mth.floor(var3.maxY + 1.0E-7D) + 1;
      int var10 = Mth.floor(var3.minZ - 1.0E-7D) - 1;
      int var11 = Mth.floor(var3.maxZ + 1.0E-7D) + 1;
