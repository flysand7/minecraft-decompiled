...
public class SignBlockEntity extends BlockEntity {
   ...
   public boolean isFacingFrontText(Player var1) {
      ...
      if (var3 instanceof SignBlock) {
         SignBlock var2 = (SignBlock)var3;
         ...
         float var9 = (float)(Mth.atan2(var6, var4) * 57.2957763671875D) - 90.0F;
   ...
   protected void saveAdditional(CompoundTag var1) {
      ...
      DataResult var10000 = SignText.DIRECT_CODEC.encodeStart(NbtOps.INSTANCE, this.frontText);
      Logger var10001 = LOGGER;
      Objects.requireNonNull(var10001);
      var10000.resultOrPartial(var10001::error).ifPresent((var1x) -> {
         var1.put("front_text", var1x);
      });
      var10000 = SignText.DIRECT_CODEC.encodeStart(NbtOps.INSTANCE, this.backText);
      var10001 = LOGGER;
      Objects.requireNonNull(var10001);
      var10000.resultOrPartial(var10001::error).ifPresent((var1x) -> {
   ...
   public void load(CompoundTag var1) {
      ...
      if (var1.contains("front_text")) {
         var10000 = SignText.DIRECT_CODEC.parse(NbtOps.INSTANCE, var1.getCompound("front_text"));
         var10001 = LOGGER;
         Objects.requireNonNull(var10001);
         var10000.resultOrPartial(var10001::error).ifPresent((var1x) -> {
      ...
      if (var1.contains("back_text")) {
         var10000 = SignText.DIRECT_CODEC.parse(NbtOps.INSTANCE, var1.getCompound("back_text"));
         var10001 = LOGGER;
         Objects.requireNonNull(var10001);
         var10000.resultOrPartial(var10001::error).ifPresent((var1x) -> {
   ...
   public boolean playerIsTooFarAwayToEdit(UUID var1) {
      ...
      return var2 == null || var2.distanceToSqr((double)this.getBlockPos().getX(), (double)this.getBlockPos().getY(), (double)this.getBlockPos().getZ()) > 64.0D;
   }
