...
public abstract class BlockEntity {
   ...
   public static BlockEntity loadStatic(BlockPos var0, BlockState var1, CompoundTag var2) {
      ...
      if (var4 == null) {
         ...
         return (BlockEntity)BuiltInRegistries.BLOCK_ENTITY_TYPE.getOptional(var4).map((var3x) -> {
            try {
   ...
   public void fillCrashReportCategory(CrashReportCategory var1) {
      var1.setDetail("Name", () -> {
         ResourceLocation var10000 = BuiltInRegistries.BLOCK_ENTITY_TYPE.getKey(this.getType());
