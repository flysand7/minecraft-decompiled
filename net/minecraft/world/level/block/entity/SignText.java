...
public class SignText {
   ...
   static {
      LINES_CODEC = ExtraCodecs.FLAT_COMPONENT.listOf().comapFlatMap((var0) -> {
      ...
      DIRECT_CODEC = RecordCodecBuilder.create((var0) -> {
         ...
         }), LINES_CODEC.optionalFieldOf("filtered_messages").forGetter(SignText::getOnlyFilteredMessages), DyeColor.CODEC.fieldOf("color").orElse(DyeColor.BLACK).forGetter((var0x) -> {
            return var0x.color;
