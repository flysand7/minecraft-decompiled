...
public class Containers {
   ...
   public static void dropItemStack(Level var0, double var1, double var3, double var5, ItemStack var7) {
      ...
      while(!var7.isEmpty()) {
         ...
         float var21 = 0.05F;
         var20.setDeltaMovement(var0.random.triangle(0.0D, 0.11485000171139836D), var0.random.triangle(0.2D, 0.11485000171139836D), var0.random.triangle(0.0D, 0.11485000171139836D));
