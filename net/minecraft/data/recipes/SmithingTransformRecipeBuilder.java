...
public class SmithingTransformRecipeBuilder {
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      var1.accept(new SmithingTransformRecipeBuilder.Result(var2, this.type, this.template, this.base, this.addition, this.result, this.advancement, var2.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
   ...
   public static record Result(ResourceLocation a, RecipeSerializer<?> b, Ingredient c, Ingredient d, Ingredient e, Item f, Advancement.Builder g, ResourceLocation h) implements FinishedRecipe {
      ...
      public Result(ResourceLocation var1, RecipeSerializer<?> var2, Ingredient var3, Ingredient var4, Ingredient var5, Item var6, Advancement.Builder var7, ResourceLocation var8) {
         this.id = var1;
         this.type = var2;
         this.template = var3;
         this.base = var4;
