...
public class SmithingTrimRecipeBuilder {
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      var1.accept(new SmithingTrimRecipeBuilder.Result(var2, this.type, this.template, this.base, this.addition, this.advancement, var2.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
   ...
   public static record Result(ResourceLocation a, RecipeSerializer<?> b, Ingredient c, Ingredient d, Ingredient e, Advancement.Builder f, ResourceLocation g) implements FinishedRecipe {
      ...
      public Result(ResourceLocation var1, RecipeSerializer<?> var2, Ingredient var3, Ingredient var4, Ingredient var5, Advancement.Builder var6, ResourceLocation var7) {
         this.id = var1;
         this.type = var2;
         this.template = var3;
         this.base = var4;
