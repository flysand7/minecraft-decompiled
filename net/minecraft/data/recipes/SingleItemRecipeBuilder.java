...
public class SingleItemRecipeBuilder implements RecipeBuilder {
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      var1.accept(new SingleItemRecipeBuilder.Result(var2, this.type, this.group == null ? "" : this.group, this.ingredient, this.result, this.count, this.advancement, var2.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
