...
public class SimpleCookingRecipeBuilder implements RecipeBuilder {
   ...
   private SimpleCookingRecipeBuilder(RecipeCategory var1, CookingBookCategory var2, ItemLike var3, Ingredient var4, float var5, int var6, RecipeSerializer<? extends AbstractCookingRecipe> var7) {
      this.category = var1;
   ...
   public static SimpleCookingRecipeBuilder generic(Ingredient var0, RecipeCategory var1, ItemLike var2, float var3, int var4, RecipeSerializer<? extends AbstractCookingRecipe> var5) {
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      var1.accept(new SimpleCookingRecipeBuilder.Result(var2, this.group == null ? "" : this.group, this.bookCategory, this.ingredient, this.result, this.experience, this.cookingTime, this.advancement, var2.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.serializer));
   }
   ...
   private static class Result implements FinishedRecipe {
      ...
      public Result(ResourceLocation var1, String var2, CookingBookCategory var3, Ingredient var4, Item var5, float var6, int var7, Advancement.Builder var8, ResourceLocation var9, RecipeSerializer<? extends AbstractCookingRecipe> var10) {
         this.id = var1;
         this.group = var2;
         this.category = var3;
         this.ingredient = var4;
