...
public class ShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      var1.accept(new ShapedRecipeBuilder.Result(var2, this.result, this.count, this.group == null ? "" : this.group, determineBookCategory(this.category), this.rows, this.key, this.advancement, var2.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.showNotification));
   }
   ...
   static class Result extends CraftingRecipeBuilder.CraftingResult {
      ...
      public Result(ResourceLocation var1, Item var2, int var3, String var4, CraftingBookCategory var5, List<String> var6, Map<Character, Ingredient> var7, Advancement.Builder var8, ResourceLocation var9, boolean var10) {
         super(var5);
         this.id = var1;
         this.result = var2;
         this.count = var3;
