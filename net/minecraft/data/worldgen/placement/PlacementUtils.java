...
public class PlacementUtils {
   ...
   public static void register(BootstapContext<PlacedFeature> var0, ResourceKey<PlacedFeature> var1, Holder<ConfiguredFeature<?, ?>> var2, List<PlacementModifier> var3) {
      var0.register(var1, new PlacedFeature(var2, List.copyOf(var3)));
   }

   public static void register(BootstapContext<PlacedFeature> var0, ResourceKey<PlacedFeature> var1, Holder<ConfiguredFeature<?, ?>> var2, PlacementModifier... var3) {
