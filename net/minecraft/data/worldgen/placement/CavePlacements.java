...
public class CavePlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, UNDERWATER_MAGMA, var8, (PlacementModifier[])(CountPlacement.of(UniformInt.of(44, 52)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, SurfaceRelativeThresholdFilter.of(Heightmap.Types.OCEAN_FLOOR_WG, Integer.MIN_VALUE, -2), BiomeFilter.biome()));
      PlacementUtils.register(var0, GLOW_LICHEN, var9, (PlacementModifier[])(CountPlacement.of(UniformInt.of(104, 157)), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, InSquarePlacement.spread(), SurfaceRelativeThresholdFilter.of(Heightmap.Types.OCEAN_FLOOR_WG, Integer.MIN_VALUE, -13), BiomeFilter.biome()));
