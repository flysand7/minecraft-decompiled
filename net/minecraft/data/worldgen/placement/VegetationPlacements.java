...
public class VegetationPlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, BAMBOO, var3, (PlacementModifier[])(NoiseBasedCountPlacement.of(160, 80.0D, 0.3D), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
      ...
      PlacementUtils.register(var0, PATCH_GRASS_PLAIN, var7, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8D, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));
      ...
      PlacementUtils.register(var0, PATCH_TALL_GRASS_2, var15, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8D, 0, 7), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
      ...
      PlacementUtils.register(var0, FLOWER_PLAINS, var24, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8D, 15, 4), RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
      PlacementUtils.register(var0, FLOWER_CHERRY, var26, (PlacementModifier[])(NoiseThresholdCountPlacement.of(-0.8D, 5, 10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
