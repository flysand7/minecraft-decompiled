...
public class OrePlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> var0) {
      ...
      PlacementUtils.register(var0, ORE_DIAMOND_LARGE, var22, (List)rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
      PlacementUtils.register(var0, ORE_DIAMOND_BURIED, var23, (List)commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
      PlacementUtils.register(var0, ORE_LAPIS, var24, (List)commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32))));
      PlacementUtils.register(var0, ORE_LAPIS_BURIED, var25, (List)commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(64))));
      PlacementUtils.register(var0, ORE_INFESTED, var26, (List)commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(63))));
      PlacementUtils.register(var0, ORE_EMERALD, var27, (List)commonOrePlacement(100, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(480))));
      PlacementUtils.register(var0, ORE_ANCIENT_DEBRIS_LARGE, var28, (PlacementModifier[])(InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.absolute(8), VerticalAnchor.absolute(24)), BiomeFilter.biome()));
      PlacementUtils.register(var0, ORE_ANCIENT_DEBRIS_SMALL, var29, (PlacementModifier[])(InSquarePlacement.spread(), PlacementUtils.RANGE_8_8, BiomeFilter.biome()));
      PlacementUtils.register(var0, ORE_COPPER, var30, (List)commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));
      PlacementUtils.register(var0, ORE_COPPER_LARGE, var31, (List)commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112))));
      PlacementUtils.register(var0, ORE_CLAY, var32, (List)commonOrePlacement(46, PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT));
   }
}
