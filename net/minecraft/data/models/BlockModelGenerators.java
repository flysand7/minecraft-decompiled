...
public class BlockModelGenerators {
   ...
   private void createPitcherCrop() {
      ...
      PropertyDispatch var2 = PropertyDispatch.properties(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF).generate((var1x, var2x) -> {
         ...
         switch(var2x) {
         case UPPER:
            var10000 = Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(var1, "_top_stage_" + var1x));
            break;
         case LOWER:
            var10000 = Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(var1, "_bottom_stage_" + var1x));
            break;
         default:
   ...
   private void createChiseledBookshelf() {
      ...
      ResourceLocation var2 = ModelLocationUtils.getModelLocation(var1);
      MultiPartGenerator var3 = MultiPartGenerator.multiPart(var1);
      Map.of(Direction.NORTH, VariantProperties.Rotation.R0, Direction.EAST, VariantProperties.Rotation.R90, Direction.SOUTH, VariantProperties.Rotation.R180, Direction.WEST, VariantProperties.Rotation.R270).forEach((var3x, var4) -> {
         Condition.TerminalCondition var5 = Condition.condition().term(BlockStateProperties.HORIZONTAL_FACING, var3x);
         var3.with(var5, (Variant)Variant.variant().with(VariantProperties.MODEL, var2).with(VariantProperties.Y_ROT, var4).with(VariantProperties.UV_LOCK, true));
   ...
   private static record BookSlotModelCacheKey(ModelTemplate a, String b) {
