...
public class GameEventTagsProvider extends IntrinsicHolderTagsProvider<GameEvent> {
   ...
   public GameEventTagsProvider(PackOutput var1, CompletableFuture<HolderLookup.Provider> var2) {
      super(var1, Registries.GAME_EVENT, var2, (var0) -> {
         return var0.builtInRegistryHolder().key();
      });
   }

   protected void addTags(HolderLookup.Provider var1) {
      this.tag(GameEventTags.VIBRATIONS).add((Object[])VIBRATIONS_EXCEPT_FLAP).add((Object[])VibrationSystem.RESONANCE_EVENTS).add((Object)GameEvent.FLAP);
      this.tag(GameEventTags.SHRIEKER_CAN_LISTEN).add((Object)GameEvent.SCULK_SENSOR_TENDRILS_CLICKING);
      this.tag(GameEventTags.WARDEN_CAN_LISTEN).add((Object[])VIBRATIONS_EXCEPT_FLAP).add((Object[])VibrationSystem.RESONANCE_EVENTS).add((Object)GameEvent.SHRIEK).addTag(GameEventTags.SHRIEKER_CAN_LISTEN);
