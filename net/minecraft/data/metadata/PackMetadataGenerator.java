...
public class PackMetadataGenerator implements DataProvider {
   ...
   public static PackMetadataGenerator forFeaturePack(PackOutput var0, Component var1) {
      return (new PackMetadataGenerator(var0)).add(PackMetadataSection.TYPE, new PackMetadataSection(var1, DetectedVersion.BUILT_IN.getPackVersion(PackType.SERVER_DATA)));
   }
