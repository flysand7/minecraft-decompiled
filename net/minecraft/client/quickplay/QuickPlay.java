...
public class QuickPlay {
   ...
   private static void joinRealmsWorld(Minecraft var0, RealmsClient var1, String var2) {
      ...
      if (var6 == null) {
         ...
         var7 = new TitleScreen();
         GetServerDetailsTask var8 = new GetServerDetailsTask(new RealmsMainScreen(var7), var7, var6, new ReentrantLock());
         var0.setScreen(new RealmsLongRunningMcoTaskScreen(var7, var8));
      }
   }
}
