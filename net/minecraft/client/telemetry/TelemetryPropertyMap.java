...
public class TelemetryPropertyMap {
   ...
   public static Codec<TelemetryPropertyMap> createCodec(final List<TelemetryProperty<?>> var0) {
      return (new MapCodec<TelemetryPropertyMap>() {
         ...
         private <T, V> DataResult<TelemetryPropertyMap.Builder> decodeProperty(DataResult<TelemetryPropertyMap.Builder> var1, DynamicOps<T> var2, MapLike<T> var3, TelemetryProperty<V> var4) {
