...
public record TelemetryProperty<T>(String F, String G, Codec<T> H, TelemetryProperty.Exporter<T> I) {
   ...
   public static enum GameMode implements StringRepresentable {
      ...
      // $FF: synthetic method
      private static TelemetryProperty.GameMode[] $values() {
         return new TelemetryProperty.GameMode[]{SURVIVAL, CREATIVE, ADVENTURE, SPECTATOR, HARDCORE};
      }
   }
   ...
   public static enum ServerType implements StringRepresentable {
      ...
      // $FF: synthetic method
      private static TelemetryProperty.ServerType[] $values() {
         return new TelemetryProperty.ServerType[]{REALM, LOCAL, OTHER};
      }
   }
}
