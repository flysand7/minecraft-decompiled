...
public class PauseScreen extends Screen {
   ...
   public void render(GuiGraphics var1, int var2, int var3, float var4) {
      ...
      if (this.showPauseMenu && this.minecraft != null && this.minecraft.getReportingContext().hasDraftReport() && this.disconnectButton != null) {
         var1.blit(AbstractWidget.WIDGETS_LOCATION, this.disconnectButton.getX() + this.disconnectButton.getWidth() - 17, this.disconnectButton.getY() + 3, 182, 24, 15, 15);
      }
   ...
   private Button openLinkButton(Component var1, String var2) {
      return this.openScreenButton(var1, () -> {
