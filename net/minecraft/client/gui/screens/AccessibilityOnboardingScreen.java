...
public class AccessibilityOnboardingScreen extends Screen {
   ...
   public void init() {
      ...
      GridLayout var3 = (GridLayout)var2.addChild(new GridLayout());
      ...
      var4.addChild(CommonButtons.accessibilityTextAndImage((var1x) -> {
         this.closeAndSetScreen(new AccessibilityOptionsScreen(this, this.minecraft.options));
      }));
      var4.addChild(CommonButtons.languageTextAndImage((var1x) -> {
         this.closeAndSetScreen(new LanguageSelectScreen(this, this.minecraft.options, this.minecraft.getLanguageManager()));
      }));
      var2.addChild(Button.builder(CommonComponents.GUI_CONTINUE, (var1x) -> {
         this.onClose();
      }).build(), var2.newChildLayoutSettings().alignVerticallyBottom().padding(8));
