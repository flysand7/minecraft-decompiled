...
public class DeathScreen extends Screen {
   ...
   private void handleExitToTitleScreen() {
      if (this.hardcore) {
         ...
         DeathScreen.TitleConfirmScreen var1 = new DeathScreen.TitleConfirmScreen((var1x) -> {
            if (var1x) {
               this.exitToTitleScreen();
            } else {
               this.minecraft.player.respawn();
   ...
   public void render(GuiGraphics var1, int var2, int var3, float var4) {
      ...
      if (this.exitToTitleButton != null && this.minecraft.getReportingContext().hasDraftReport()) {
         var1.blit(AbstractWidget.WIDGETS_LOCATION, this.exitToTitleButton.getX() + this.exitToTitleButton.getWidth() - 17, this.exitToTitleButton.getY() + 3, 182, 24, 15, 15);
      }
