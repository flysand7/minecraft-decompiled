...
public class WorldOpenFlows {
   ...
   public void createFreshLevel(String var1, LevelSettings var2, WorldOptions var3, Function<RegistryAccess, WorldDimensions> var4) {
      ...
      if (var5 != null) {
         ...
         try {
            ...
            WorldStem var9 = (WorldStem)this.loadWorldDataBlocking(var8, (var3x) -> {
   ...
   private WorldStem loadWorldStem(LevelStorageSource.LevelStorageAccess var1, boolean var2, PackRepository var3) throws Exception {
      ...
      return (WorldStem)this.loadWorldDataBlocking(var4, (var1x) -> {
         RegistryOps var2 = RegistryOps.create(NbtOps.INSTANCE, (HolderLookup.Provider)var1x.datapackWorldgen());
         Registry var3 = var1x.datapackDimensions().registryOrThrow(Registries.LEVEL_STEM);
         Pair var4 = var1.getDataTag(var2, var1x.dataConfiguration(), var3, var1x.datapackWorldgen().allRegistriesLifecycle());
         if (var4 == null) {
            throw new IllegalStateException("Failed to load world");
         } else {
            return new WorldLoader.DataLoadOutput((WorldData)var4.getFirst(), ((WorldDimensions.Complete)var4.getSecond()).dimensionsRegistryAccess());
         }
      }, WorldStem::new);
   }
   ...
   public Pair<LevelSettings, WorldCreationContext> recreateWorldData(LevelStorageSource.LevelStorageAccess var1) throws Exception {
      ...
      return (Pair)this.loadWorldDataBlocking(var3, (var1x) -> {
         RegistryOps var2 = RegistryOps.create(NbtOps.INSTANCE, (HolderLookup.Provider)var1x.datapackWorldgen());
         Registry var3 = (new MappedRegistry(Registries.LEVEL_STEM, Lifecycle.stable())).freeze();
         Pair var4 = var1.getDataTag(var2, var1x.dataConfiguration(), var3, var1x.datapackWorldgen().allRegistriesLifecycle());
         if (var4 == null) {
            throw new IllegalStateException("Failed to load world");
         } else {
            record Data(LevelSettings a, WorldOptions b, Registry<LevelStem> c) {
               ...
               Data(LevelSettings var1, WorldOptions var2, Registry<LevelStem> var3) {
            ...
            return new WorldLoader.DataLoadOutput(new Data(((WorldData)var4.getFirst()).getLevelSettings(), ((WorldData)var4.getFirst()).worldGenOptions(), ((WorldDimensions.Complete)var4.getSecond()).dimensions()), var1x.datapackDimensions());
         }
   ...
   private void doLoadLevel(Screen var1, String var2, boolean var3, boolean var4) {
      ...
      if (var5 != null) {
         ...
         if (!var4 || !var9 && !var10) {
            this.minecraft.getDownloadedPackSource().loadBundledResourcePack(var5).thenApply((var0) -> {
               return true;
