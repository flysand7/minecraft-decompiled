...
public class TelemetryInfoScreen extends Screen {
   ...
   protected void init() {
      ...
      GridLayout var2 = (GridLayout)var1.addChild(new GridLayout(), var1.newChildLayoutSettings().align(0.5F, 0.0F));
      ...
      GridLayout var4 = this.twoButtonContainer(Button.builder(BUTTON_GIVE_FEEDBACK, this::openFeedbackLink).build(), Button.builder(BUTTON_SHOW_DATA, this::openDataFolder).build());
      var3.addChild(var4);
   ...
   private AbstractWidget createTelemetryButton() {
      AbstractWidget var1 = this.options.telemetryOptInExtra().createButton(this.options, 0, 0, 150, (var1x) -> {
         this.telemetryEventWidget.onOptInChanged(var1x);
      });
