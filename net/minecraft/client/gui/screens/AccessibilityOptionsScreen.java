...
public class AccessibilityOptionsScreen extends SimpleOptionsSubScreen {
   private static OptionInstance<?>[] options(Options var0) {
      return new OptionInstance[]{var0.narrator(), var0.showSubtitles(), var0.highContrast(), var0.autoJump(), var0.textBackgroundOpacity(), var0.backgroundForChatOnly(), var0.chatOpacity(), var0.chatLineSpacing(), var0.chatDelay(), var0.notificationDisplayTime(), var0.toggleCrouch(), var0.toggleSprint(), var0.screenEffectScale(), var0.fovEffectScale(), var0.darknessEffectScale(), var0.damageTiltStrength(), var0.glintSpeed(), var0.glintStrength(), var0.hideLightningFlash(), var0.darkMojangStudiosBackground(), var0.panoramaSpeed()};
   }
   ...
   protected void createFooter() {
      this.addRenderableWidget(Button.builder(Component.translatable("options.accessibility.link"), (var1) -> {
