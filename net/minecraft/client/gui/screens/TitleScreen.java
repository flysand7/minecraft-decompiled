...
public class TitleScreen extends Screen {
   ...
   public static CompletableFuture<Void> preloadResources(TextureManager var0, Executor var1) {
      return CompletableFuture.allOf(var0.preload(LogoRenderer.MINECRAFT_LOGO, var1), var0.preload(LogoRenderer.MINECRAFT_EDITION, var1), var0.preload(PANORAMA_OVERLAY, var1), CUBE_MAP.preload(var0, var1));
   }
   ...
   protected void init() {
      ...
      this.addRenderableWidget(new ImageButton(this.width / 2 + 104, var4 + 72 + 12, 20, 20, 0, 0, 20, Button.ACCESSIBILITY_TEXTURE, 32, 64, (var1x) -> {
   ...
   public void render(GuiGraphics var1, int var2, int var3, float var4) {
      ...
      if ((var7 & -67108864) != 0) {
         ...
         var1.drawString(this.font, (String)var8, 2, this.height - 10, 16777215 | var7);
