...
public class OverlayRecipeComponent implements Renderable, GuiEventListener {
   ...
   private class OverlayRecipeButton extends AbstractWidget implements PlaceRecipe<Ingredient> {
      ...
      public void renderWidget(GuiGraphics var1, int var2, int var3, float var4) {
         ...
         var1.pose().pushPose();
         var1.pose().translate((double)(this.getX() + 2), (double)(this.getY() + 2), 150.0D);

         for(Iterator var7 = this.ingredientPos.iterator(); var7.hasNext(); var1.pose().popPose()) {
            OverlayRecipeComponent.OverlayRecipeButton.Pos var8 = (OverlayRecipeComponent.OverlayRecipeButton.Pos)var7.next();
            var1.pose().pushPose();
            var1.pose().translate((double)var8.x, (double)var8.y, 0.0D);
            var1.pose().scale(0.375F, 0.375F, 1.0F);
            var1.pose().translate(-8.0D, -8.0D, 0.0D);
