...
public abstract class Screen extends AbstractContainerEventHandler implements Renderable {
   ...
   protected void updateNarratedWidget(NarrationElementOutput var1) {
      List var2 = (List)this.narratables.stream().filter(NarratableEntry::isActive).collect(Collectors.toList());
   ...
   private static record DeferredTooltipRendering(List<FormattedCharSequence> a, ClientTooltipPositioner b) {
