...
public class TransferableSelectionList extends ObjectSelectionList<TransferableSelectionList.PackEntry> {
   ...
   protected void renderHeader(GuiGraphics var1, int var2, int var3) {
      ...
      var1.drawString(this.minecraft.font, (Component)var4, var2 + this.width / 2 - this.minecraft.font.width((FormattedText)var4) / 2, Math.min(this.y0 + 3, var3), 16777215, false);
   }
   ...
   public boolean keyPressed(int var1, int var2, int var3) {
      if (this.getSelected() != null) {
         ...
         case 32:
         case 257:
            ((TransferableSelectionList.PackEntry)this.getSelected()).keyboardSelection();
            return true;
         default:
            if (Screen.hasShiftDown()) {
               switch(var1) {
               case 264:
                  ((TransferableSelectionList.PackEntry)this.getSelected()).keyboardMoveDown();
                  return true;
               case 265:
                  ((TransferableSelectionList.PackEntry)this.getSelected()).keyboardMoveUp();
                  return true;
               }
            }
         }
