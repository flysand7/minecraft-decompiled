...
public class AnvilScreen extends ItemCombinerScreen<AnvilMenu> {
   ...
   private void onNameChanged(String var1) {
      ...
      if (var2.hasItem()) {
         ...
         if (((AnvilMenu)this.menu).setItemName(var3)) {
            this.minecraft.player.connection.send((Packet)(new ServerboundRenameItemPacket(var3)));
         }
   ...
   protected void renderBg(GuiGraphics var1, float var2, int var3, int var4) {
      ...
      var1.blit(ANVIL_LOCATION, this.leftPos + 59, this.topPos + 20, 0, this.imageHeight + (((AnvilMenu)this.menu).getSlot(0).hasItem() ? 0 : 16), 110, 16);
   }
