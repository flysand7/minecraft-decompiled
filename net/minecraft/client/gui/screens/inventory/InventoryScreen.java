...
public class InventoryScreen extends EffectRenderingInventoryScreen<InventoryMenu> implements RecipeUpdateListener {
   ...
   protected void renderBg(GuiGraphics var1, float var2, int var3, int var4) {
      ...
      renderEntityInInventoryFollowsMouse(var1, var5 + 51, var6 + 75, 30, (float)(var5 + 51) - this.xMouse, (float)(var6 + 75 - 50) - this.yMouse, this.minecraft.player);
   }
   ...
   public static void renderEntityInInventory(GuiGraphics var0, int var1, int var2, int var3, Quaternionf var4, @Nullable Quaternionf var5, LivingEntity var6) {
      var0.pose().pushPose();
      var0.pose().translate((double)var1, (double)var2, 50.0D);
      ...
      RenderSystem.runAsFancy(() -> {
         var7.render(var6, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, var0.pose(), var0.bufferSource(), 15728880);
      });
      var0.flush();
