...
public class GridLayout extends AbstractLayout {
   ...
   public void arrangeElements() {
      ...
      int var11;
      while(var5.hasNext()) {
         GridLayout.CellInhabitant var6 = (GridLayout.CellInhabitant)var5.next();
      ...
      while(var17.hasNext()) {
         GridLayout.CellInhabitant var16 = (GridLayout.CellInhabitant)var17.next();
         var9 = 0;
   ...
   public <T extends LayoutElement> T addChild(T var1, int var2, int var3, LayoutSettings var4) {
      return this.addChild(var1, var2, var3, 1, 1, var4);
   }
   ...
   public final class RowHelper {
      ...
      public <T extends LayoutElement> T addChild(T var1, int var2, LayoutSettings var3) {
         ...
         this.index += var2;
         return GridLayout.this.addChild(var1, var4, var5, 1, var2, var3);
      }
