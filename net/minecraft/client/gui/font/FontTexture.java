   ...
   public BakedGlyph add(SheetGlyphInfo var1) {
      if (var1.isColored() != this.colored) {
         ...
         if (var2 != null) {
            ...
            float var4 = 256.0F;
            float var5 = 0.01F;
            return new BakedGlyph(this.renderTypes, ((float)var2.x + 0.01F) / 256.0F, ((float)var2.x - 0.01F + (float)var1.getPixelWidth()) / 256.0F, ((float)var2.y + 0.01F) / 256.0F, ((float)var2.y - 0.01F + (float)var1.getPixelHeight()) / 256.0F, var1.getLeft(), var1.getRight(), var1.getUp(), var1.getDown());
         } else {
            return null;
         }
      }
