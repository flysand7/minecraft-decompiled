...
public class ImageButton extends Button {
   ...
   public void renderWidget(GuiGraphics var1, int var2, int var3, float var4) {
      this.renderTexture(var1, this.resourceLocation, this.getX(), this.getY(), this.xTexStart, this.yTexStart, this.yDiffTex, this.width, this.height, this.textureWidth, this.textureHeight);
   }
}
