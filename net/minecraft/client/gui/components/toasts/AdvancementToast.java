...
public class AdvancementToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics var1, ToastComponent var2, long var3) {
      ...
      if (var5 != null) {
         ...
         if (var6.size() == 1) {
            var1.drawString(var2.getMinecraft().font, (Component)var5.getFrame().getDisplayName(), 30, 7, var7 | -16777216, false);
            ...
            if (var3 < 1500L) {
               ...
               var1.drawString(var2.getMinecraft().font, (Component)var5.getFrame().getDisplayName(), 30, 11, var7 | var10, false);
            } else {
         ...
         return (double)var3 >= 5000.0D * var2.getNotificationDisplayTimeMultiplier() ? Toast.Visibility.HIDE : Toast.Visibility.SHOW;
      } else {
