...
public class RecipeToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics var1, ToastComponent var2, long var3) {
      ...
      if (this.recipes.isEmpty()) {
         ...
         Recipe var5 = (Recipe)this.recipes.get((int)((double)var3 / Math.max(1.0D, 5000.0D * var2.getNotificationDisplayTimeMultiplier() / (double)this.recipes.size()) % (double)this.recipes.size()));
         ...
         return (double)(var3 - this.lastChanged) >= 5000.0D * var2.getNotificationDisplayTimeMultiplier() ? Toast.Visibility.HIDE : Toast.Visibility.SHOW;
      }
   }
