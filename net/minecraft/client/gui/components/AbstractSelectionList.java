...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerEventHandler implements Renderable, NarratableEntry {
   ...
   public E getFirstElement() {
      return (AbstractSelectionList.Entry)this.children.get(0);
   }
   ...
   public void render(GuiGraphics var1, int var2, int var3, float var4) {
      ...
      if (this.renderBackground) {
         ...
         boolean var7 = true;
         var1.blit(Screen.BACKGROUND_LOCATION, this.x0, this.y0, (float)this.x1, (float)(this.y1 + (int)this.getScrollAmount()), this.x1 - this.x0, this.y1 - this.y0, 32, 32);
      ...
      if (this.renderTopAndBottom) {
         ...
         var1.setColor(1.0F, 1.0F, 1.0F, 1.0F);
         boolean var10 = true;
         var1.fillGradient((RenderType)RenderType.guiOverlay(), this.x0, this.y0, this.x1, this.y0 + 4, -16777216, 0, 0);
         var1.fillGradient((RenderType)RenderType.guiOverlay(), this.x0, this.y1 - 4, this.x1, this.y1, 0, -16777216, 0);
      }
   ...
   public void setFocused(@Nullable GuiEventListener var1) {
      ...
      if (var2 >= 0) {
         AbstractSelectionList.Entry var3 = (AbstractSelectionList.Entry)this.children.get(var2);
