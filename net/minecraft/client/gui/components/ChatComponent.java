...
public class ChatComponent {
   ...
   public void render(GuiGraphics var1, int var2, int var3, int var4) {
      if (!this.isChatHidden()) {
         ...
         if (var6 > 0) {
            ...
            double var13 = (Double)this.minecraft.options.chatOpacity().get() * 0.8999999761581421D + 0.10000000149011612D;
            ...
            int var20 = (int)Math.round(-8.0D * (var17 + 1.0D) + 4.0D * var17);
            int var21 = 0;
            ...
            for(int var22 = 0; var22 + this.chatScrollbarPos < this.trimmedMessages.size() && var22 < var5; ++var22) {
               ...
               if (var24 != null) {
                  ...
                  if (var25 < 200 || var7) {
                     double var26 = var7 ? 1.0D : getTimeFactor(var25);
                     var28 = (int)(255.0D * var26 * var13);
                     var29 = (int)(255.0D * var26 * var15);
                     ++var21;
                     if (var28 > 3) {
                        boolean var30 = false;
            ...
            int var38;
            if (var37 > 0L) {
               var38 = (int)(128.0D * var13);
               var25 = (int)(255.0D * var15);
               var1.pose().pushPose();
            ...
            if (var7) {
               ...
               int var27 = this.chatScrollbarPos * var39 / var6 - var11;
               var28 = var39 * var39 / var25;
               if (var25 != var39) {
                  var29 = var27 > 0 ? 170 : 96;
                  int var40 = this.newMessageSinceScroll ? 13382451 : 3355562;
                  var31 = var9 + 4;
                  var1.fill(var31, -var27, var31 + 2, -var27 - var28, var40 + (var29 << 24));
                  var1.fill(var31 + 2, -var27, var31 + 1, -var27 - var28, 13421772 + (var29 << 24));
               }
            }
   ...
   private void logChatMessage(Component var1, @Nullable GuiMessageTag var2) {
      ...
      String var4 = (String)Optionull.map(var2, GuiMessageTag::logTag);
      if (var4 != null) {
   ...
   private double screenToChatX(double var1) {
      return var1 / this.getScale() - 4.0D;
   }
   ...
   private int getMessageLineIndexAt(double var1, double var3) {
      if (this.isChatFocused() && !this.minecraft.options.hideGui && !this.isChatHidden()) {
         if (!(var1 < -4.0D) && !(var1 > (double)Mth.floor((double)this.getWidth() / this.getScale()))) {
            int var5 = Math.min(this.getLinesPerPage(), this.trimmedMessages.size());
            if (var3 >= 0.0D && var3 < (double)var5) {
   ...
   private static record DelayedMessageDeletion(MessageSignature a, int b) {
