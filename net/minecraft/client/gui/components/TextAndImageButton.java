...
public class TextAndImageButton extends Button {
   ...
   TextAndImageButton(Component var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, ResourceLocation var11, Button.OnPress var12) {
   ...
   public void renderWidget(GuiGraphics var1, int var2, int var3, float var4) {
      ...
      this.renderTexture(var1, this.resourceLocation, this.getXOffset(), this.getYOffset(), this.xTexStart, this.yTexStart, this.yDiffTex, this.usedTextureWidth, this.usedTextureHeight, this.textureWidth, this.textureHeight);
   }
