...
public class SubtitleOverlay implements SoundEventListener {
   ...
   public void render(GuiGraphics var1) {
      ...
      if (this.isListening && !this.subtitles.isEmpty()) {
         ...
         int var6 = 0;
         int var7 = 0;
         double var8 = (Double)this.minecraft.options.notificationDisplayTime().get();
         Iterator var10 = this.subtitles.iterator();

         SubtitleOverlay.Subtitle var11;
         while(var10.hasNext()) {
            var11 = (SubtitleOverlay.Subtitle)var10.next();
            if ((double)var11.getTime() + 3000.0D * var8 <= (double)Util.getMillis()) {
               var10.remove();
            } else {
               var7 = Math.max(var7, this.minecraft.font.width((FormattedText)var11.getText()));
            }
         }

         var7 += this.minecraft.font.width("<") + this.minecraft.font.width(" ") + this.minecraft.font.width(">") + this.minecraft.font.width(" ");

         for(var10 = this.subtitles.iterator(); var10.hasNext(); ++var6) {
            var11 = (SubtitleOverlay.Subtitle)var10.next();
            boolean var12 = true;
            Component var13 = var11.getText();
            Vec3 var14 = var11.getLocation().subtract(var2).normalize();
            double var15 = -var5.dot(var14);
            double var17 = -var3.dot(var14);
            boolean var19 = var17 > 0.5D;
            int var20 = var7 / 2;
            Objects.requireNonNull(this.minecraft.font);
            byte var21 = 9;
            int var22 = var21 / 2;
            float var23 = 1.0F;
            int var24 = this.minecraft.font.width((FormattedText)var13);
            int var25 = Mth.floor(Mth.clampedLerp(255.0F, 75.0F, (float)(Util.getMillis() - var11.getTime()) / (float)(3000.0D * var8)));
            int var26 = var25 << 16 | var25 << 8 | var25;
            var1.pose().pushPose();
            var1.pose().translate((float)var1.guiWidth() - (float)var20 * 1.0F - 2.0F, (float)(var1.guiHeight() - 35) - (float)(var6 * (var21 + 1)) * 1.0F, 0.0F);
