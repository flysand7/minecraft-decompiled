...
public abstract class SingleQuadParticle extends Particle {
   ...
   public void render(VertexConsumer var1, Camera var2, float var3) {
      ...
      Vector3f[] var9 = new Vector3f[]{new Vector3f(-1.0F, -1.0F, 0.0F), new Vector3f(-1.0F, 1.0F, 0.0F), new Vector3f(1.0F, 1.0F, 0.0F), new Vector3f(1.0F, -1.0F, 0.0F)};
      ...
      var1.vertex((double)var9[0].x(), (double)var9[0].y(), (double)var9[0].z()).uv(var17, var14).color(this.rCol, this.gCol, this.bCol, this.alpha).uv2(var15).endVertex();
      var1.vertex((double)var9[1].x(), (double)var9[1].y(), (double)var9[1].z()).uv(var17, var13).color(this.rCol, this.gCol, this.bCol, this.alpha).uv2(var15).endVertex();
      var1.vertex((double)var9[2].x(), (double)var9[2].y(), (double)var9[2].z()).uv(var16, var13).color(this.rCol, this.gCol, this.bCol, this.alpha).uv2(var15).endVertex();
      var1.vertex((double)var9[3].x(), (double)var9[3].y(), (double)var9[3].z()).uv(var16, var14).color(this.rCol, this.gCol, this.bCol, this.alpha).uv2(var15).endVertex();
   }
