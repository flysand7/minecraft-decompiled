...
public class CherryParticle extends TextureSheetParticle {
   ...
   public void tick() {
      ...
      if (!this.removed) {
         ...
         double var3 = Math.cos(Math.toRadians((double)(this.particleRandom * 60.0F))) * 2.0D * Math.pow((double)var2, 1.25D);
         double var5 = Math.sin(Math.toRadians((double)(this.particleRandom * 60.0F))) * 2.0D * Math.pow((double)var2, 1.25D);
