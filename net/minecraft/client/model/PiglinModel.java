...
public class PiglinModel<T extends Mob> extends PlayerModel<T> {
   ...
   public void setupAnim(LivingEntity var1, float var2, float var3, float var4, float var5, float var6) {
      this.setupAnim((Mob)var1, var2, var3, var4, var5, var6);
   }

   // $FF: synthetic method
   // $FF: bridge method
   protected void setupAttackAnimation(LivingEntity var1, float var2) {
      this.setupAttackAnimation((Mob)var1, var2);
   }
