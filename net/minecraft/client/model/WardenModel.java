...
public class WardenModel<T extends Warden> extends HierarchicalModel<T> {
   ...
   private void animateTendrils(T var1, float var2, float var3) {
      float var4 = var1.getTendrilAnimation(var3) * (float)(Math.cos((double)var2 * 2.25D) * 3.141592653589793D * 0.10000000149011612D);
   ...
   public void setupAnim(Entity var1, float var2, float var3, float var4, float var5, float var6) {
      this.setupAnim((Warden)var1, var2, var3, var4, var5, var6);
   }
}
