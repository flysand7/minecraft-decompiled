...
public class RaftModel extends ListModel<Boat> {
   ...
   public static void createChildren(PartDefinition var0) {
      var0.addOrReplaceChild("bottom", CubeListBuilder.create().texOffs(0, 0).addBox(-14.0F, -11.0F, -4.0F, 28.0F, 20.0F, 4.0F).texOffs(0, 0).addBox(-14.0F, -9.0F, -8.0F, 28.0F, 16.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -2.0F, 1.0F, 1.5708F, 0.0F, 0.0F));
      boolean var1 = true;
      boolean var2 = true;
      boolean var3 = true;
      float var4 = -5.0F;
   ...
   public void setupAnim(Entity var1, float var2, float var3, float var4, float var5, float var6) {
      this.setupAnim((Boat)var1, var2, var3, var4, var5, var6);
   }
}
