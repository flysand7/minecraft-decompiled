...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   private void sendPosition() {
      ...
      if (this.isControlledCamera()) {
         ...
         boolean var12 = Mth.lengthSquared(var15, var4, var6) > Mth.square(2.0E-4D) || this.positionReminder >= 20;
         boolean var13 = var8 != 0.0D || var10 != 0.0D;
         if (this.isPassenger()) {
            Vec3 var14 = this.getDeltaMovement();
            this.connection.send((Packet)(new ServerboundMovePlayerPacket.PosRot(var14.x, -999.0D, var14.z, this.getYRot(), this.getXRot(), this.onGround())));
            var12 = false;
         } else if (var12 && var13) {
   ...
   public void aiStep() {
      ...
      if (this.getAbilities().flying && this.isControlledCamera()) {
         ...
         if (var12 != 0) {
            this.setDeltaMovement(this.getDeltaMovement().add(0.0D, (double)((float)var12 * this.getAbilities().getFlyingSpeed() * 3.0F), 0.0D));
         }
      }
