...
public class ChatListener {
   ...
   public void tick() {
      if (this.messageDelay != 0L) {
         if (Util.getMillis() >= this.previousMessageTime + this.messageDelay) {
            for(ChatListener.Message var1 = (ChatListener.Message)this.delayedMessageQueue.poll(); var1 != null && !var1.accept(); var1 = (ChatListener.Message)this.delayedMessageQueue.poll()) {
            }
         }
   ...
   private static record Message(@Nullable MessageSignature a, BooleanSupplier b) {
      @Nullable
