...
public final class ReportingContext {
   ...
   public void draftReportHandled(Minecraft var1, @Nullable Screen var2, Runnable var3, boolean var4) {
      if (this.chatReportDraft != null) {
         ...
         }, Component.translatable(var4 ? "gui.chatReport.draft.quittotitle.title" : "gui.chatReport.draft.title"), Component.translatable(var4 ? "gui.chatReport.draft.quittotitle.content" : "gui.chatReport.draft.content"), Component.translatable("gui.chatReport.draft.edit"), Component.translatable("gui.chatReport.draft.discard")));
      } else {
         var3.run();
      }
