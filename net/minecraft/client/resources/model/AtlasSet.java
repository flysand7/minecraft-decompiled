...
public class AtlasSet implements AutoCloseable {
   ...
   public AtlasSet(Map<ResourceLocation, ResourceLocation> var1, TextureManager var2) {
      this.atlases = (Map)var1.entrySet().stream().collect(Collectors.toMap(Entry::getKey, (var1x) -> {
   ...
   public TextureAtlas getAtlas(ResourceLocation var1) {
      return ((AtlasSet.AtlasEntry)this.atlases.get(var1)).atlas();
   }
   ...
   public Map<ResourceLocation, CompletableFuture<AtlasSet.StitchResult>> scheduleLoad(ResourceManager var1, int var2, Executor var3) {
      return (Map)this.atlases.entrySet().stream().collect(Collectors.toMap(Entry::getKey, (var3x) -> {
         ...
         return SpriteLoader.create(var4.atlas).loadAndStitch(var1, var4.atlasInfoLocation, var2, var3).thenApply((var1x) -> {
            return new AtlasSet.StitchResult(var4.atlas, var1x);
         });
      }));
   }
