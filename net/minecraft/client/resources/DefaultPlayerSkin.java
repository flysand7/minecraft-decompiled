...
public class DefaultPlayerSkin {
   private static final DefaultPlayerSkin.SkinType[] DEFAULT_SKINS;
   ...
   private static enum ModelType {
      ...
      // $FF: synthetic method
      private static DefaultPlayerSkin.ModelType[] $values() {
         return new DefaultPlayerSkin.ModelType[]{SLIM, WIDE};
      }
   }
}
