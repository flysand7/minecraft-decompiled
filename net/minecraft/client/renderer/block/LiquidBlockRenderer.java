   ...
   public void tesselate(BlockAndTintGetter var1, BlockPos var2, VertexConsumer var3, BlockState var4, FluidState var5) {
      ...
      if (var24 || var25 || var29 || var28 || var26 || var27) {
         ...
         if (var24 && !isFaceOccludedByNeighbor(var1, var2, Direction.UP, Math.min(Math.min(var36, var38), Math.min(var37, var35)), var14)) {
            ...
            float var59;
            float var61;
            if (var56.x == 0.0D && var56.z == 0.0D) {
               var57 = var7[0];
               var48 = var57.getU(0.0D);
               var52 = var57.getV(0.0D);
               var49 = var48;
               var53 = var57.getV(16.0D);
               var50 = var57.getU(16.0D);
               var54 = var53;
               var51 = var50;
               var55 = var52;
            } else {
            ...
            this.vertex(var3, var73 + 0.0D, var74 + (double)var36, var44 + 0.0D, var61, var62, var63, var48, var52, var84);
            this.vertex(var3, var73 + 0.0D, var74 + (double)var38, var44 + 1.0D, var61, var62, var63, var49, var53, var84);
            this.vertex(var3, var73 + 1.0D, var74 + (double)var37, var44 + 1.0D, var61, var62, var63, var50, var54, var84);
            this.vertex(var3, var73 + 1.0D, var74 + (double)var35, var44 + 0.0D, var61, var62, var63, var51, var55, var84);
         ...
         if (var25) {
            ...
            var54 = var30 * var10;
            var55 = var30 * var11;
            this.vertex(var3, var73, var74 + (double)var47, var44 + 1.0D, var53, var54, var55, var48, var51, var78);
            this.vertex(var3, var73, var74 + (double)var47, var44, var53, var54, var55, var48, var50, var78);
            this.vertex(var3, var73 + 1.0D, var74 + (double)var47, var44, var53, var54, var55, var49, var50, var78);
            this.vertex(var3, var73 + 1.0D, var74 + (double)var47, var44 + 1.0D, var53, var54, var55, var49, var51, var78);
         }
         ...
         while(true) {
            ...
            do {
               do {
                  ...
                  case NORTH:
                     ...
                     var79 = var73;
                     var82 = var73 + 1.0D;
                     var80 = var44 + 0.0010000000474974513D;
                     var83 = var44 + 0.0010000000474974513D;
                     var85 = var26;
                     break;
                  case SOUTH:
                     var51 = var37;
                     ...
                     var79 = var73 + 1.0D;
                     var82 = var73;
                     var80 = var44 + 1.0D - 0.0010000000474974513D;
                     var83 = var44 + 1.0D - 0.0010000000474974513D;
                     var85 = var27;
                     break;
                  case WEST:
                     var51 = var38;
                     var52 = var36;
                     var79 = var73 + 0.0010000000474974513D;
                     var82 = var73 + 0.0010000000474974513D;
                     var80 = var44 + 1.0D;
                     var83 = var44;
                     var85 = var28;
                     break;
                  default:
                     var51 = var35;
                     var52 = var37;
                     var79 = var73 + 1.0D - 0.0010000000474974513D;
                     var82 = var73 + 1.0D - 0.0010000000474974513D;
                     var80 = var44;
                     var83 = var44 + 1.0D;
                     var85 = var29;
                  }
            ...
            float var88 = var87.getU(0.0D);
            float var65 = var87.getU(8.0D);
            float var66 = var87.getV((double)((1.0F - var51) * 16.0F * 0.5F));
            float var67 = var87.getV((double)((1.0F - var52) * 16.0F * 0.5F));
            float var68 = var87.getV(8.0D);
