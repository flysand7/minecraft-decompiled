...
public class FogRenderer {
   ...
   public static void setupColor(Camera var0, float var1, ClientLevel var2, int var3, float var4) {
      ...
      if (var5 == FogType.WATER) {
         ...
         Vec3 var29 = var0.getPosition().subtract(2.0D, 2.0D, 2.0D).scale(0.25D);
      ...
      FogRenderer.MobEffectFogFunction var21 = getPriorityFogFunction(var6, var1);
      if (var21 != null) {
   ...
   private static FogRenderer.MobEffectFogFunction getPriorityFogFunction(Entity var0, float var1) {
      if (var0 instanceof LivingEntity) {
         ...
         return (FogRenderer.MobEffectFogFunction)MOB_EFFECT_FOG.stream().filter((var2x) -> {
   ...
   private static class DarknessFogFunction implements FogRenderer.MobEffectFogFunction {
      DarknessFogFunction() {
      }
