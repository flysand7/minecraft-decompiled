...
public class FishingHookRenderer extends EntityRenderer<FishingHook> {
   ...
   public void render(FishingHook var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var7 != null) {
         ...
         if ((this.entityRenderDispatcher.options == null || this.entityRenderDispatcher.options.getCameraType().isFirstPerson()) && var7 == Minecraft.getInstance().player) {
            var32 = 960.0D / (double)(Integer)this.entityRenderDispatcher.options.fov().get();
   ...
   public ResourceLocation getTextureLocation(Entity var1) {
      return this.getTextureLocation((FishingHook)var1);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public void render(Entity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      this.render((FishingHook)var1, var2, var3, var4, var5, var6);
   }
