...
public class IllusionerRenderer extends IllagerRenderer<Illusioner> {
   ...
   public IllusionerRenderer(EntityRendererProvider.Context var1) {
      ...
      this.addLayer(new ItemInHandLayer<Illusioner, IllagerModel<Illusioner>>(this, var1.getItemInHandRenderer()) {
         ...
         public void render(PoseStack var1, MultiBufferSource var2, int var3, LivingEntity var4, float var5, float var6, float var7, float var8, float var9, float var10) {
            this.render(var1, var2, var3, (Illusioner)var4, var5, var6, var7, var8, var9, var10);
         }
   ...
   public void render(Mob var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      this.render((Illusioner)var1, var2, var3, var4, var5, var6);
   }
   ...
   public ResourceLocation getTextureLocation(Entity var1) {
      return this.getTextureLocation((Illusioner)var1);
   }
