...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   ...
   public ResourceLocation getTextureLocation(Entity var1) {
      return this.getTextureLocation((EnderDragon)var1);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public void render(Entity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      this.render((EnderDragon)var1, var2, var3, var4, var5, var6);
   }
   ...
   public static class DragonModel extends EntityModel<EnderDragon> {
      ...
      public void prepareMobModel(Entity var1, float var2, float var3, float var4) {
         this.prepareMobModel((EnderDragon)var1, var2, var3, var4);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void setupAnim(Entity var1, float var2, float var3, float var4, float var5, float var6) {
         this.setupAnim((EnderDragon)var1, var2, var3, var4, var5, var6);
      }
   }
}
