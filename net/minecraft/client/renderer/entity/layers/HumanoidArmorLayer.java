...
public class HumanoidArmorLayer<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> extends RenderLayer<T, M> {
      ...
      if (var9 instanceof ArmorItem) {
         ...
         if (var8.getEquipmentSlot() == var4) {
            ...
            if (var8 instanceof DyeableArmorItem) {
               DyeableArmorItem var10 = (DyeableArmorItem)var8;
               int var11 = var10.getColor(var7);
               float var12 = (float)(var11 >> 16 & 255) / 255.0F;
               float var13 = (float)(var11 >> 8 & 255) / 255.0F;
               float var14 = (float)(var11 & 255) / 255.0F;
               this.renderModel(var1, var2, var5, var8, var6, var15, var12, var13, var14, (String)null);
               this.renderModel(var1, var2, var5, var8, var6, var15, 1.0F, 1.0F, 1.0F, "overlay");
            } else {
               this.renderModel(var1, var2, var5, var8, var6, var15, 1.0F, 1.0F, 1.0F, (String)null);
            }

            ArmorTrim.getTrim(var3.level().registryAccess(), var7).ifPresent((var7x) -> {
               this.renderTrim(var8.getMaterial(), var1, var2, var5, var7x, var6, var15);
            });
            if (var7.hasFoil()) {
   ...
   private void renderModel(PoseStack var1, MultiBufferSource var2, int var3, ArmorItem var4, A var5, boolean var6, float var7, float var8, float var9, @Nullable String var10) {
