...
public class WardenEmissiveLayer<T extends Warden, M extends WardenModel<T>> extends RenderLayer<T, M> {
   ...
   public WardenEmissiveLayer(RenderLayerParent<T, M> var1, ResourceLocation var2, WardenEmissiveLayer.AlphaFunction<T> var3, WardenEmissiveLayer.DrawSelector<T, M> var4) {
      super(var1);
      this.texture = var2;
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, Entity var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      this.render(var1, var2, var3, (Warden)var4, var5, var6, var7, var8, var9, var10);
   }
