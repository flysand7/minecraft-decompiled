...
public class PandaRenderer extends MobRenderer<Panda, PandaModel<Panda>> {
   ...
   protected void setupRotations(Panda var1, PoseStack var2, float var3, float var4, float var5) {
      ...
      if (var15 > 0.0F) {
         ...
         var2.translate(0.0F, var8 * var15, 0.0F);
         var2.mulPose(Axis.XP.rotationDegrees(Mth.lerp(var15, var1.getXRot(), var1.getXRot() + 180.0F)));
      }
   ...
   protected void setupRotations(LivingEntity var1, PoseStack var2, float var3, float var4, float var5) {
      this.setupRotations((Panda)var1, var2, var3, var4, var5);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public ResourceLocation getTextureLocation(Entity var1) {
      return this.getTextureLocation((Panda)var1);
   }
}
