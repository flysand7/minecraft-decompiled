...
public abstract class MobRenderer<T extends Mob, M extends EntityModel<T>> extends LivingEntityRenderer<T, M> {
   ...
   private <E extends Entity> void renderLeash(T var1, float var2, PoseStack var3, MultiBufferSource var4, E var5) {
      ...
      double var7 = (double)(Mth.lerp(var2, var1.yBodyRotO, var1.yBodyRot) * 0.017453292F) + 1.5707963267948966D;
   ...
   public void render(LivingEntity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      this.render((Mob)var1, var2, var3, var4, var5, var6);
   }
   ...
   public boolean shouldRender(Entity var1, Frustum var2, double var3, double var5, double var7) {
      return this.shouldRender((Mob)var1, var2, var3, var5, var7);
   }
}
