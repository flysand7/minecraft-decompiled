...
public class PufferfishRenderer extends MobRenderer<Pufferfish, EntityModel<Pufferfish>> {
   ...
   public void render(Mob var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      this.render((Pufferfish)var1, var2, var3, var4, var5, var6);
   }

   // $FF: synthetic method
   // $FF: bridge method
   protected void setupRotations(LivingEntity var1, PoseStack var2, float var3, float var4, float var5) {
      this.setupRotations((Pufferfish)var1, var2, var3, var4, var5);
   }
   ...
   public ResourceLocation getTextureLocation(Entity var1) {
      return this.getTextureLocation((Pufferfish)var1);
   }
