...
public abstract class EntityRenderer<T extends Entity> {
   ...
   protected void renderNameTag(T var1, Component var2, PoseStack var3, MultiBufferSource var4, int var5) {
      ...
      if (!(var6 > 4096.0D)) {
         ...
         var14.drawInBatch(var2, var15, (float)var10, 553648127, false, var11, var4, var8 ? Font.DisplayMode.SEE_THROUGH : Font.DisplayMode.NORMAL, var13, var5);
         if (var8) {
            var14.drawInBatch((Component)var2, var15, (float)var10, -1, false, var11, var4, Font.DisplayMode.NORMAL, 0, var5);
         }
