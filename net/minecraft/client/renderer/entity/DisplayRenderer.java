...
public abstract class DisplayRenderer<T extends Display, S> extends EntityRenderer<T> {
   ...
   public void render(T var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var7 != null) {
         ...
         if (var8 != null) {
            ...
            var4.pushPose();
            var4.mulPose(this.calculateOrientation(var7, var1));
   ...
   private Quaternionf calculateOrientation(Display.RenderState var1, T var2) {
      ...
      case FIXED:
         var10000 = var2.orientation();
         break;
      case HORIZONTAL:
         var10000 = (new Quaternionf()).rotationYXZ(-0.017453292F * var2.getYRot(), -0.017453292F * var3.getXRot(), 0.0F);
         break;
      case VERTICAL:
         var10000 = (new Quaternionf()).rotationYXZ(3.1415927F - 0.017453292F * var3.getYRot(), 0.017453292F * var2.getXRot(), 0.0F);
         break;
      case CENTER:
         var10000 = (new Quaternionf()).rotationYXZ(3.1415927F - 0.017453292F * var3.getYRot(), -0.017453292F * var3.getXRot(), 0.0F);
         break;
      default:
   ...
   public static class TextDisplayRenderer extends DisplayRenderer<Display.TextDisplay, Display.TextDisplay.TextRenderState> {
      ...
      public void renderInner(Display.TextDisplay var1, Display.TextDisplay.TextRenderState var2, PoseStack var3, MultiBufferSource var4, int var5, float var6) {
         ...
         for(Iterator var23 = var16.lines().iterator(); var23.hasNext(); var14 += (float)var17) {
            ...
            case LEFT:
               ...
               break;
            case RIGHT:
               var10000 = (float)(var18 - var21.width());
               break;
            case CENTER:
               var10000 = (float)var18 / 2.0F - (float)var21.width() / 2.0F;
               break;
            default:
               throw new IncompatibleClassChangeError();
            }
      ...
      // $FF: synthetic method
      // $FF: bridge method
      public void renderInner(Display var1, Object var2, PoseStack var3, MultiBufferSource var4, int var5, float var6) {
         this.renderInner((Display.TextDisplay)var1, (Display.TextDisplay.TextRenderState)var2, var3, var4, var5, var6);
      }
      ...
      // $FF: bridge method
      public ResourceLocation getTextureLocation(Entity var1) {
         return super.getTextureLocation((Display)var1);
      }

      // $FF: synthetic method
      // $FF: bridge method
      public void render(Entity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
         super.render((Display)var1, var2, var3, var4, var5, var6);
      }
   }
   ...
   public static class ItemDisplayRenderer extends DisplayRenderer<Display.ItemDisplay, Display.ItemDisplay.ItemRenderState> {
      ...
      // $FF: bridge method
      public void renderInner(Display var1, Object var2, PoseStack var3, MultiBufferSource var4, int var5, float var6) {
         this.renderInner((Display.ItemDisplay)var1, (Display.ItemDisplay.ItemRenderState)var2, var3, var4, var5, var6);
      }
   ...
   public static class BlockDisplayRenderer extends DisplayRenderer<Display.BlockDisplay, Display.BlockDisplay.BlockRenderState> {
      ...
      // $FF: bridge method
      public void renderInner(Display var1, Object var2, PoseStack var3, MultiBufferSource var4, int var5, float var6) {
         this.renderInner((Display.BlockDisplay)var1, (Display.BlockDisplay.BlockRenderState)var2, var3, var4, var5, var6);
      }
