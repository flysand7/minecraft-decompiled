...
public class BeaconRenderer implements BlockEntityRenderer<BeaconBlockEntity> {
   ...
   // $FF: synthetic method
   // $FF: bridge method
   public boolean shouldRender(BlockEntity var1, Vec3 var2) {
      return this.shouldRender((BeaconBlockEntity)var1, var2);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public boolean shouldRenderOffScreen(BlockEntity var1) {
      return this.shouldRenderOffScreen((BeaconBlockEntity)var1);
   }

   // $FF: synthetic method
   // $FF: bridge method
   public void render(BlockEntity var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
      this.render((BeaconBlockEntity)var1, var2, var3, var4, var5, var6);
   }
}
