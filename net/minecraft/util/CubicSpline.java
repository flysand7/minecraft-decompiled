...
public interface CubicSpline<C, I extends ToFloatFunction<C>> extends ToFloatFunction<C> {
   ...
   static <C, I extends ToFloatFunction<C>> Codec<CubicSpline<C, I>> codec(Codec<I> var0) {
      ...
      Codec var2 = RecordCodecBuilder.create((var1x) -> {
         ...
         return var1x.group(var10001, ExtraCodecs.lazyInitializedCodec(var1::getValue).fieldOf("value").forGetter(Point::value), Codec.FLOAT.fieldOf("derivative").forGetter(Point::derivative)).apply(var1x, (var0, var1xx, var2) -> {
            record Point<C, I extends ToFloatFunction<C>>(float a, CubicSpline<C, I> b, float c) {
               ...
               Point(float var1, CubicSpline<C, I> var2, float var3) {
                  this.location = var1;
                  this.value = var2;
            ...
            return new Point(var0, var1xx, var2);
         });
      });
      Codec var3 = RecordCodecBuilder.create((var2x) -> {
         return var2x.group(var0.fieldOf("coordinate").forGetter(CubicSpline.Multipoint::coordinate), ExtraCodecs.nonEmptyList(var2.listOf()).fieldOf("points").forGetter((var0x) -> {
            return IntStream.range(0, var0x.locations.length).mapToObj((var1) -> {
               return new Point(var0x.locations()[var1], (CubicSpline)var0x.values().get(var1), var0x.derivatives()[var1]);
            }).toList();
   ...
   public static record Multipoint<C, I extends ToFloatFunction<C>>(I b, float[] c, List<CubicSpline<C, I>> d, float[] e, float f, float g) implements CubicSpline<C, I> {
      ...
      static <C, I extends ToFloatFunction<C>> CubicSpline.Multipoint<C, I> create(I var0, float[] var1, List<CubicSpline<C, I>> var2, float[] var3) {
         ...
         return new CubicSpline.Multipoint(var0, var1, var2, var3, var5, var6);
      }
