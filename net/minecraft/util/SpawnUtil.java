...
public class SpawnUtil {
   ...
   public static <T extends Mob> Optional<T> trySpawnMob(EntityType<T> var0, MobSpawnType var1, ServerLevel var2, BlockPos var3, int var4, int var5, int var6, SpawnUtil.Strategy var7) {
      ...
      for(int var9 = 0; var9 < var4; ++var9) {
         ...
         if (var2.getWorldBorder().isWithinBounds((BlockPos)var8) && moveToPossibleSpawnPosition(var2, var6, var8, var7)) {
            Mob var12 = (Mob)var0.create(var2, (CompoundTag)null, (Consumer)null, var8, var1, false, false);
            if (var12 != null) {
   ...
   public interface Strategy {
      ...
      SpawnUtil.Strategy ON_TOP_OF_COLLIDER = (var0, var1, var2, var3, var4) -> {
