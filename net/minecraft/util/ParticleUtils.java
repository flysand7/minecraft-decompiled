...
public class ParticleUtils {
   ...
   private static Vec3 getRandomSpeedRanges(RandomSource var0) {
      return new Vec3(Mth.nextDouble(var0, -0.5D, 0.5D), Mth.nextDouble(var0, -0.5D, 0.5D), Mth.nextDouble(var0, -0.5D, 0.5D));
   }
   ...
   public static void spawnParticleOnFace(Level var0, BlockPos var1, Direction var2, ParticleOptions var3, Vec3 var4, double var5) {
      ...
      double var11 = var7.x + (var8 == 0 ? Mth.nextDouble(var0.random, -0.5D, 0.5D) : (double)var8 * var5);
      double var13 = var7.y + (var9 == 0 ? Mth.nextDouble(var0.random, -0.5D, 0.5D) : (double)var9 * var5);
      double var15 = var7.z + (var10 == 0 ? Mth.nextDouble(var0.random, -0.5D, 0.5D) : (double)var10 * var5);
      double var17 = var8 == 0 ? var4.x() : 0.0D;
      double var19 = var9 == 0 ? var4.y() : 0.0D;
      double var21 = var10 == 0 ? var4.z() : 0.0D;
   ...
   public static void spawnParticleBelow(Level var0, BlockPos var1, RandomSource var2, ParticleOptions var3) {
      ...
      double var6 = (double)var1.getY() - 0.05D;
      double var8 = (double)var1.getZ() + var2.nextDouble();
      var0.addParticle(var3, var4, var6, var8, 0.0D, 0.0D, 0.0D);
   }
}
