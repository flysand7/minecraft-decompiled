...
public class Advancement {
   ...
   public Advancement(ResourceLocation var1, @Nullable Advancement var2, @Nullable DisplayInfo var3, AdvancementRewards var4, Map<String, Criterion> var5, String[][] var6, boolean var7) {
      this.id = var1;
      this.display = var3;
      ...
      if (var3 == null) {
         ...
         MutableComponent var11 = var8.copy().withStyle((var1x) -> {
            return var1x.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, var10));
         });
      ...
      public static Advancement.Builder fromJson(JsonObject var0, DeserializationContext var1) {
         ...
         if (var5.isEmpty()) {
            ...
            if (var7.length == 0) {
               ...
               String var22;
               for(Iterator var16 = var5.keySet().iterator(); var16.hasNext(); var7[var8++] = new String[]{var22}) {
            ...
            do {
               if (!var19.hasNext()) {
                  boolean var20 = GsonHelper.getAsBoolean(var0, "sends_telemetry_event", false);
                  return new Advancement.Builder(var2, var3, var4, var5, var7, var20);
               }
               ...
               for(var13 = 0; var13 < var25; ++var13) {
                  String[] var26 = var23[var13];
                  if (ArrayUtils.contains(var26, var21)) {
                     var24 = true;
                     break;
                  }
               }
            ...
            throw new JsonSyntaxException("Criterion '" + var21 + "' isn't a requirement for completion. This isn't supported behaviour, all criteria must be required.");
         }
      }
