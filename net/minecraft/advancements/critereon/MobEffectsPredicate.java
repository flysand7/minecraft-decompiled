   ...
   public static MobEffectsPredicate fromJson(@Nullable JsonElement var0) {
      if (var0 != null && !var0.isJsonNull()) {
         ...
         while(var3.hasNext()) {
            ...
            MobEffect var6 = (MobEffect)BuiltInRegistries.MOB_EFFECT.getOptional(var5).orElseThrow(() -> {
   ...
   public JsonElement serializeToJson() {
      if (this == ANY) {
         ...
         while(var2.hasNext()) {
            ...
            var1.add(BuiltInRegistries.MOB_EFFECT.getKey((MobEffect)var3.getKey()).toString(), ((MobEffectsPredicate.MobEffectInstancePredicate)var3.getValue()).serializeToJson());
         }
