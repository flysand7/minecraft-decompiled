         ...
         if (var1.has("data")) {
            ...
            if (var6 != null) {
               ...
               while(var8.hasNext()) {
                  ...
                  var7.add((Item)BuiltInRegistries.ITEM.getOptional(var10).orElseThrow(() -> {
            ...
            if (var1.has("tag")) {
               ...
               var12 = TagKey.create(Registries.ITEM, var13);
            }

            Potion var14 = null;
            if (var1.has("potion")) {
               ResourceLocation var15 = new ResourceLocation(GsonHelper.getAsString(var1, "potion"));
               var14 = (Potion)BuiltInRegistries.POTION.getOptional(var15).orElseThrow(() -> {
