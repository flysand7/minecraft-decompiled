...
public class CriteriaTriggers {
   ...
   public static final ItemUsedOnLocationTrigger PLACED_BLOCK = (ItemUsedOnLocationTrigger)register(new ItemUsedOnLocationTrigger(new ResourceLocation("placed_block")));
   ...
   public static final ItemUsedOnLocationTrigger ITEM_USED_ON_BLOCK = (ItemUsedOnLocationTrigger)register(new ItemUsedOnLocationTrigger(new ResourceLocation("item_used_on_block")));
   ...
   public static final ItemUsedOnLocationTrigger ALLAY_DROP_ITEM_ON_BLOCK = (ItemUsedOnLocationTrigger)register(new ItemUsedOnLocationTrigger(new ResourceLocation("allay_drop_item_on_block")));
   ...
   public static final RecipeCraftedTrigger RECIPE_CRAFTED = (RecipeCraftedTrigger)register(new RecipeCraftedTrigger());
