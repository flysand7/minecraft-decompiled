   ...
   public static class ItemStackInfo {
      ...
      private static HoverEvent.ItemStackInfo create(JsonElement var0) {
         if (var0.isJsonPrimitive()) {
            return new HoverEvent.ItemStackInfo((Item)BuiltInRegistries.ITEM.get(new ResourceLocation(var0.getAsString())), 1, (CompoundTag)null);
         } else {
            JsonObject var1 = GsonHelper.convertToJsonObject(var0, "item");
            Item var2 = (Item)BuiltInRegistries.ITEM.get(new ResourceLocation(GsonHelper.getAsString(var1, "id")));
   ...
   public static class EntityTooltipInfo {
      ...
      public static HoverEvent.EntityTooltipInfo create(JsonElement var0) {
         if (!var0.isJsonObject()) {
            ...
            EntityType var2 = (EntityType)BuiltInRegistries.ENTITY_TYPE.get(new ResourceLocation(GsonHelper.getAsString(var1, "type")));
      ...
      public static HoverEvent.EntityTooltipInfo create(Component var0) {
         try {
            ...
            EntityType var3 = (EntityType)BuiltInRegistries.ENTITY_TYPE.get(new ResourceLocation(var1.getString("type")));
