...
public class SignedMessageChain {
   ...
   public SignedMessageChain.Encoder encoder(Signer var1) {
      return (var2) -> {
         ...
         return var3 == null ? null : new MessageSignature(var1.sign((var2x) -> {
   ...
   public SignedMessageChain.Decoder decoder(ProfilePublicKey var1) {
      ...
      return (var3, var4) -> {
         ...
         if (var5 == null) {
            ...
            PlayerChatMessage var6 = new PlayerChatMessage(var5, var3, var4, (Component)null, FilterMask.PASS_THROUGH);
            if (!var6.verify(var2)) {
   ...
   public interface Encoder {
      SignedMessageChain.Encoder UNSIGNED = (var0) -> {
         return null;
      };
   ...
   public interface Decoder {
      ...
      static SignedMessageChain.Decoder unsigned(UUID var0) {
         return (var1, var2) -> {
            return PlayerChatMessage.unsigned(var0, var2.content());
         };
      }
