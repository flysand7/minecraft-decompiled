...
public record ClientboundLoginPacket(int a, boolean b, GameType c, @Nullable GameType d, Set<ResourceKey<Level>> e, RegistryAccess.Frozen f, ResourceKey<DimensionType> g, ResourceKey<Level> h, long i, int j, int k, int l, boolean m, boolean n, boolean o, boolean p, Optional<GlobalPos> q, int r) implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundLoginPacket(FriendlyByteBuf var1) {
      ...
      }), ((RegistryAccess)var1.readWithCodec(BUILTIN_CONTEXT_OPS, RegistrySynchronization.NETWORK_CODEC)).freeze(), var1.readResourceKey(Registries.DIMENSION_TYPE), var1.readResourceKey(Registries.DIMENSION), var1.readLong(), var1.readVarInt(), var1.readVarInt(), var1.readVarInt(), var1.readBoolean(), var1.readBoolean(), var1.readBoolean(), var1.readBoolean(), var1.readOptional(FriendlyByteBuf::readGlobalPos), var1.readVarInt());
   }

   public ClientboundLoginPacket(int var1, boolean var2, GameType var3, @Nullable GameType var4, Set<ResourceKey<Level>> var5, RegistryAccess.Frozen var6, ResourceKey<DimensionType> var7, ResourceKey<Level> var8, long var9, int var11, int var12, int var13, boolean var14, boolean var15, boolean var16, boolean var17, Optional<GlobalPos> var18, int var19) {
      this.playerId = var1;
      this.hardcore = var2;
      this.gameType = var3;
