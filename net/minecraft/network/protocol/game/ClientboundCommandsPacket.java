...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
   ...
   private static ClientboundCommandsPacket.Entry createEntry(CommandNode<SharedSuggestionProvider> var0, Object2IntMap<CommandNode<SharedSuggestionProvider>> var1) {
      int var2 = 0;
      int var3;
      ...
      return new ClientboundCommandsPacket.Entry((ClientboundCommandsPacket.NodeStub)var4, var2, var3, var7);
   }
   ...
   public RootCommandNode<SharedSuggestionProvider> getRoot(CommandBuildContext var1) {
      return (RootCommandNode)(new ClientboundCommandsPacket.NodeResolver(var1, this.entries)).resolve(this.rootIndex);
   }
