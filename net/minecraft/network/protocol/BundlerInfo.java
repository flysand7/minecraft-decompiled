...
public interface BundlerInfo {
   ...
   static <T extends PacketListener, P extends BundlePacket<T>> BundlerInfo createForPacket(final Class<P> var0, final Function<Iterable<Packet<T>>, P> var1, final BundleDelimiterPacket<T> var2) {
