...
public class ServerFunctionManager {
   ...
   private class ExecutionContext {
      ...
      private CommandSourceStack wrapSender(CommandSourceStack var1) {
         ...
         return var2 instanceof ServerFunctionManager.ExecutionContext.AbortingReturnValueConsumer ? var1 : var1.withReturnValueConsumer(new ServerFunctionManager.ExecutionContext.AbortingReturnValueConsumer(var2));
      }
      ...
      int runTopCommand(CommandFunction var1, CommandSourceStack var2) {
         ...
         do {
            ...
            try {
               ServerFunctionManager.QueuedCommand var12 = (ServerFunctionManager.QueuedCommand)this.commandQueue.removeFirst();
               ProfilerFiller var10000 = ServerFunctionManager.this.server.getProfiler();
               Objects.requireNonNull(var12);
               var10000.push(var12::toString);
               this.depth = var12.depth;
               var12.execute(ServerFunctionManager.this, this.commandQueue, var3, this.tracer);
