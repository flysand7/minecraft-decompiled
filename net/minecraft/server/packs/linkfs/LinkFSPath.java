...
class LinkFSPath implements Path {
   ...
   public File toFile() {
      ...
      if (var2 instanceof PathContents.FileContents) {
         PathContents.FileContents var1 = (PathContents.FileContents)var2;
   ...
   public PathContents.DirectoryContents getDirectoryContents() {
      ...
      if (var2 instanceof PathContents.DirectoryContents) {
         PathContents.DirectoryContents var1 = (PathContents.DirectoryContents)var2;
         var10000 = var1;
      } else {
         var10000 = null;
      }
   ...
   public int compareTo(Object var1) {
      return this.compareTo((Path)var1);
   }
}
