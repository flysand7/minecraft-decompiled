...
public class StopSoundCommand {
   ...
   private static int stopSound(CommandSourceStack var0, Collection<ServerPlayer> var1, @Nullable SoundSource var2, @Nullable ResourceLocation var3) {
      ...
      if (var2 != null) {
         if (var3 != null) {
            var0.sendSuccess(() -> {
               return Component.translatable("commands.stopsound.success.source.sound", var3, var2.getName());
            }, true);
         } else {
            var0.sendSuccess(() -> {
         ...
         var0.sendSuccess(() -> {
            return Component.translatable("commands.stopsound.success.sourceless.sound", var3);
         }, true);
      } else {
         var0.sendSuccess(() -> {
