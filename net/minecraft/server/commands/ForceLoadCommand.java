...
public class ForceLoadCommand {
   ...
   private static int queryForceLoad(CommandSourceStack var0, ColumnPos var1) throws CommandSyntaxException {
      ...
      if (var5) {
         var0.sendSuccess(() -> {
            return Component.translatable("commands.forceload.query.success", var2, var4.location());
         }, false);
         return 1;
      } else {
   ...
   private static int listForceLoad(CommandSourceStack var0) {
      ...
      if (var4 > 0) {
         ...
         if (var4 == 1) {
            var0.sendSuccess(() -> {
               return Component.translatable("commands.forceload.list.single", var2.location(), var5);
            }, false);
         } else {
            var0.sendSuccess(() -> {
               return Component.translatable("commands.forceload.list.multiple", var4, var2.location(), var5);
            }, false);
         }
      } else {
   ...
   private static int removeAll(CommandSourceStack var0) {
      ...
      var0.sendSuccess(() -> {
         return Component.translatable("commands.forceload.removed.all", var2.location());
      }, true);
      return 0;
   }
      ...
      if (var4 >= -30000000 && var5 >= -30000000 && var6 < 30000000 && var7 < 30000000) {
         ...
         if (var12 > 256L) {
            ...
            if (var17 == 0) {
               ...
               if (var17 == 1) {
                  var0.sendSuccess(() -> {
                     return Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".single", var16, var15.location());
                  }, true);
               } else {
                  ChunkPos var21 = new ChunkPos(var8, var9);
                  ChunkPos var22 = new ChunkPos(var10, var11);
                  var0.sendSuccess(() -> {
                     return Component.translatable("commands.forceload." + (var3 ? "added" : "removed") + ".multiple", var16, var15.location(), var21, var22);
                  }, true);
               }
