   ...
   private static int schedule(CommandSourceStack var0, Pair<ResourceLocation, Either<CommandFunction, Collection<CommandFunction>>> var1, int var2, boolean var3) throws CommandSyntaxException {
      if (var2 == 0) {
         ...
         ((Either)var1.getSecond()).ifLeft((var7x) -> {
            ...
            var0.sendSuccess(() -> {
               return Component.translatable("commands.schedule.created.function", var6, var2, var4);
            }, true);
         }).ifRight((var7x) -> {
            String var8 = "#" + var6;
            if (var3) {
            ...
            var0.sendSuccess(() -> {
               return Component.translatable("commands.schedule.created.tag", var6, var2, var4);
            }, true);
         });
