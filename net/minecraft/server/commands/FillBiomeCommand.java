...
public class FillBiomeCommand {
   ...
   private static final Dynamic2CommandExceptionType ERROR_VOLUME_TOO_LARGE = new Dynamic2CommandExceptionType((var0, var1) -> {
      return Component.translatable("commands.fillbiome.toobig", var0, var1);
   });
      ...
      if (var8 > var9) {
         ...
         for(int var12 = SectionPos.blockToSectionCoord(var7.minZ()); var12 <= SectionPos.blockToSectionCoord(var7.maxZ()); ++var12) {
            for(int var13 = SectionPos.blockToSectionCoord(var7.minX()); var13 <= SectionPos.blockToSectionCoord(var7.maxX()); ++var13) {
               var14 = var10.getChunk(var13, var12, ChunkStatus.FULL, false);
               if (var14 == null) {
         ...
         while(var16.hasNext()) {
            ...
            var14.fillBiomesFromNoise(makeResolver(var15, var14, var7, var3, var4), var10.getChunkSource().randomState().sampler());
            var14.setUnsaved(true);
         }

         var10.getChunkSource().chunkMap.resendBiomesForChunks(var11);
         var0.sendSuccess(() -> {
            return Component.translatable("commands.fillbiome.success.count", var15.getValue(), var7.minX(), var7.minY(), var7.minZ(), var7.maxX(), var7.maxY(), var7.maxZ());
         }, true);
