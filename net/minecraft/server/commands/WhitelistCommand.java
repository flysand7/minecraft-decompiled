   ...
   private static int addPlayers(CommandSourceStack var0, Collection<GameProfile> var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (!var2.isWhiteListed(var5)) {
            ...
            var2.add(var6);
            var0.sendSuccess(() -> {
               return Component.translatable("commands.whitelist.add.success", ComponentUtils.getDisplayName(var5));
            }, true);
            ++var3;
         }
      }
   ...
   private static int removePlayers(CommandSourceStack var0, Collection<GameProfile> var1) throws CommandSyntaxException {
      ...
      while(var4.hasNext()) {
         ...
         if (var2.isWhiteListed(var5)) {
            ...
            var2.remove(var6);
            var0.sendSuccess(() -> {
               return Component.translatable("commands.whitelist.remove.success", ComponentUtils.getDisplayName(var5));
            }, true);
            ++var3;
         }
      }
