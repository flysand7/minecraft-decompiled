...
public class PlaceCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      ...
      }))))).then(Commands.literal("jigsaw").then(Commands.argument("pool", ResourceKeyArgument.key(Registries.TEMPLATE_POOL)).then(Commands.argument("target", ResourceLocationArgument.id()).then(((RequiredArgumentBuilder)Commands.argument("max_depth", IntegerArgumentType.integer(1, 7)).executes((var0x) -> {
   ...
   public static int placeTemplate(CommandSourceStack var0, ResourceLocation var1, BlockPos var2, Rotation var3, Mirror var4, float var5, int var6) throws CommandSyntaxException {
      ...
      if (var9.isEmpty()) {
         ...
         if (!var12) {
            ...
            var0.sendSuccess(() -> {
               return Component.translatable("commands.place.template.success", var1, var2.getX(), var2.getY(), var2.getZ());
            }, true);
            return 1;
         }
      }
