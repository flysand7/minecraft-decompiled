...
public class SpreadPlayersCommand {
   ...
   private static void spreadPositions(Vec2 var0, double var1, ServerLevel var3, RandomSource var4, double var5, double var7, double var9, double var11, int var13, SpreadPlayersCommand.Position[] var14, boolean var15) throws CommandSyntaxException {
      boolean var16 = true;
   ...
   private static double setPlayerPositions(Collection<? extends Entity> var0, ServerLevel var1, SpreadPlayersCommand.Position[] var2, int var3, boolean var4) {
      ...
      for(Iterator var9 = var0.iterator(); var9.hasNext(); var5 += var20) {
         ...
         var10.teleportTo(var1, (double)Mth.floor(var11.x) + 0.5D, (double)var11.getSpawnY(var1, var3), (double)Mth.floor(var11.z) + 0.5D, Set.of(), var10.getYRot(), var10.getXRot());
