...
public class Main {
   ...
   public static void main(String[] var0) {
      ...
      try {
         ...
         try {
            ...
            var32 = (WorldStem)Util.blockUntilDone((var6x) -> {
               return WorldLoader.load(var33, (var5x) -> {
                  Registry var6 = var5x.datapackDimensions().registryOrThrow(Registries.LEVEL_STEM);
                  RegistryOps var7 = RegistryOps.create(NbtOps.INSTANCE, (HolderLookup.Provider)var5x.datapackWorldgen());
                  Pair var8 = var28.getDataTag(var7, var5x.dataConfiguration(), var6, var5x.datapackWorldgen().allRegistriesLifecycle());
                  if (var8 != null) {
                     return new WorldLoader.DataLoadOutput((WorldData)var8.getFirst(), ((WorldDimensions.Complete)var8.getSecond()).dimensionsRegistryAccess());
                  } else {
                     LevelSettings var9;
                     WorldOptions var10;
                     ...
                     if (var18.has(var4)) {
                        ...
                        var11 = WorldPresets.createNormalWorldDimensions(var5x.datapackWorldgen());
                     } else {
                        DedicatedServerProperties var12 = var21.getProperties();
                        var9 = new LevelSettings(var12.levelName, var12.gamemode, var12.hardcore, var12.difficulty, false, new GameRules(), var5x.dataConfiguration());
                        var10 = var18.has(var5) ? var12.worldOptions.withBonusChest(true) : var12.worldOptions;
                        var11 = var12.createDimensions(var5x.datapackWorldgen());
                     }

                     WorldDimensions.Complete var14 = var11.bake(var6);
                     Lifecycle var13 = var14.lifecycle().add(var5x.datapackWorldgen().allRegistriesLifecycle());
                     return new WorldLoader.DataLoadOutput(new PrimaryLevelData(var9, var10, var14.specialWorldProperty(), var13), var14.dimensionsRegistryAccess());
                  }
         ...
         if (var18.has(var6)) {
            forceUpgrade(var28, DataFixers.getDataFixer(), var18.has(var7), () -> {
               return true;
            }, var39.registryOrThrow(Registries.LEVEL_STEM));
         }

         WorldData var34 = var32.worldData();
         var28.saveDataTag(var39, var34);
         final DedicatedServer var35 = (DedicatedServer)MinecraftServer.spin((var12x) -> {
            DedicatedServer var13x = new DedicatedServer(var12x, var28, var31, var32, var21, DataFixers.getDataFixer(), var25, LoggerChunkProgressListener::new);
            var13x.setSingleplayerProfile(var18.has(var10) ? new GameProfile((UUID)null, (String)var18.valueOf(var10)) : null);
            var13x.setPort((Integer)var18.valueOf(var13));
   ...
   private static WorldLoader.InitConfig loadOrCreateConfig(DedicatedServerProperties var0, LevelStorageSource.LevelStorageAccess var1, boolean var2, PackRepository var3) {
