...
public class AdvancementVisibilityEvaluator {
   ...
   private static boolean evaluateVisibility(Advancement var0, Stack<AdvancementVisibilityEvaluator.VisibilityRule> var1, Predicate<Advancement> var2, AdvancementVisibilityEvaluator.Output var3) {
      ...
      Advancement var8;
      for(Iterator var7 = var0.getChildren().iterator(); var7.hasNext(); var6 |= evaluateVisibility(var8, var1, var2, var3)) {
   ...
   static enum VisibilityRule {
      ...
      // $FF: synthetic method
      private static AdvancementVisibilityEvaluator.VisibilityRule[] $values() {
         return new AdvancementVisibilityEvaluator.VisibilityRule[]{SHOW, HIDE, NO_CHANGE};
      }
   }
